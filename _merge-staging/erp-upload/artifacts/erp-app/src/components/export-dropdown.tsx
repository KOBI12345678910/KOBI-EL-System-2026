        ...
        <>
          ...
          <div className="fixed bottom-0 left-0 right-0 sm:absolute sm:bottom-auto sm:right-0 sm:left-auto sm:top-full sm:mt-1 bg-card border-t sm:border border-border sm:rounded-lg shadow-xl z-50 sm:min-w-[180px] py-1 sm:py-1">
            ...
            <button
              ...
              className="w-full flex items-center gap-3 px-5 py-3.5 sm:py-2.5 sm:px-4 text-sm text-foreground hover:bg-blue-50 hover:text-blue-700 active:bg-blue-100 transition-colors"
            >
            ...
            <button
              ...
              className="w-full flex items-center gap-3 px-5 py-3.5 sm:py-2.5 sm:px-4 text-sm text-foreground hover:bg-green-50 hover:text-green-700 active:bg-green-100 transition-colors"
            >
            ...
            <button
              ...
              className="w-full flex items-center gap-3 px-5 py-3.5 sm:py-2.5 sm:px-4 text-sm text-foreground hover:bg-muted/30 hover:text-foreground active:bg-slate-100 transition-colors"
            >
