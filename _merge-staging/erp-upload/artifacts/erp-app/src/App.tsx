...
// === AUTO-ADDED MISSING PAGE IMPORTS ===
const AIAnomalyDetectionPage = lazyPage(() => import("@/pages/ai/ai-anomaly-detection"));
const AICustomerServicePage = lazyPage(() => import("@/pages/sales/ai-customer-service"));
const AICustomerServiceProPage = lazyPage(() => import("@/pages/sales/customer-service"));
...
const AILeadScoringProPage = lazyPage(() => import("@/pages/crm/ai/lead-scoring"));
...
const ChatPage = lazyPage(() => import("@/components/ai/ai-copilot-chat"));
const ChecklistsPage = lazyPage(() => import("@/pages/documents/checklists"));
...
const ContractsPage = lazyPage(() => import("@/pages/documents/contracts"));
...
const CrmPipelinePage = lazyPage(() => import("@/pages/sales/sales-orders"));
...
const FabAccessoriesPage = lazyPage(() => import("@/pages/fabrication/accessories"));
const FabAssemblyOrdersPage = lazyPage(() => import("@/pages/fabrication/assembly-orders"));
const FabCoatingOrdersPage = lazyPage(() => import("@/pages/fabrication/coating-orders"));
const FabCuttingListsPage = lazyPage(() => import("@/pages/fabrication/cutting-lists"));
const FabFinishesColorsPage = lazyPage(() => import("@/pages/fabrication/finishes-colors"));
const FabGlassCatalogPage = lazyPage(() => import("@/pages/fabrication/glass-catalog"));
const FabGlazingOrdersPage = lazyPage(() => import("@/pages/fabrication/glazing-orders"));
const FabInstallationOrdersPage = lazyPage(() => import("@/pages/fabrication/installation-orders"));
const FabPackingListsPage = lazyPage(() => import("@/pages/fabrication/packing-lists"));
const FabProfilesPage = lazyPage(() => import("@/pages/fabrication/profiles"));
const FabServiceTicketsPage = lazyPage(() => import("@/pages/fabrication/service-tickets"));
const FabSystemsPage = lazyPage(() => import("@/pages/fabrication/systems"));
const FabTransportOrdersPage = lazyPage(() => import("@/pages/fabrication/transport-orders"));
const FabWeldingOrdersPage = lazyPage(() => import("@/pages/fabrication/welding-orders"));
const FabWorkflowTrackerPage = lazyPage(() => import("@/pages/fabrication/workflow-tracker"));
const FinControlCenterPage = lazyPage(() => import("@/pages/finance/finance-control-center"));
const FinanceFixedAssetsPage = lazyPage(() => import("@/pages/finance/fixed-assets"));
const FinancialAnalyticsPage = lazyPage(() => import("@/pages/reports/financial/analytics"));
const FinancialReportsPage = lazyPage(() => import("@/pages/finance/financial-reports"));
...
const InventoryDashboardPage = lazyPage(() => import("@/pages/dashboard"));
...
const PricingCostCalculatorPage = lazyPage(() => import("@/pages/pricing/cost-calculations"));
...
const ProcurementPage = lazyPage(() => import("@/pages/procurement"));
...
const ProcurementRiskPage = lazyPage(() => import("@/pages/executive/procurement-risk"));
...
const ProfitabilityDashboardPage = lazyPage(() => import("@/pages/executive/profitability-dashboard"));
...
const QuotationsPage = lazyPage(() => import("@/pages/modules/price-quotes"));
...
const ReportCustomerAgingPage = lazyPage(() => import("@/pages/reports/financial/customer-aging"));
const ReportExecutiveSummaryPage = lazyPage(() => import("@/pages/reports/financial/executive-summary"));
const ReportFiscalPage = lazyPage(() => import("@/pages/reports/financial/fiscal-report"));
const ReportInvoiceAnalysisPage = lazyPage(() => import("@/pages/reports/financial/invoice-analysis"));
const ReportVatPage = lazyPage(() => import("@/pages/reports/financial/vat-report"));
const ReportVendorAgingPage = lazyPage(() => import("@/pages/reports/financial/vendor-aging"));
const RevenueTrackingPage = lazyPage(() => import("@/pages/finance/revenue-tracking"));
const SafetyProceduresPage = lazyPage(() => import("@/pages/safety/procedures"));
const SafetyTrainingPage = lazyPage(() => import("@/pages/safety/training"));
const SalesInvoicingPage = lazyPage(() => import("@/pages/finance/suppliers/invoices"));
...
const TemplatesLibraryPage = lazyPage(() => import("@/pages/documents/document-templates"));
