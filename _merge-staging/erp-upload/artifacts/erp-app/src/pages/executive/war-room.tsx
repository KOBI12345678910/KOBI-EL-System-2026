...
export default function WarRoomPage() {
  ...
  const fetchData = async () => {
    try {
      setLoading(true);
      const res = await authFetch("/api/executive/war-room");
      if (res.ok) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 p-4 space-y-4" dir="rtl">
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-white">חדר מלחמה — מרכז שליטה</h1>
        ...
        <div className="flex items-center gap-3">
          ...
          <button onClick={fetchData} className="p-2 bg-slate-800 rounded-lg hover:bg-slate-700 text-muted-foreground hover:text-white transition-colors">
      ...
      <div className="grid grid-cols-12 gap-4">
        <div className="col-span-12 lg:col-span-4 bg-slate-800/60 rounded-xl border border-slate-700/40 p-4">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="text-sm font-medium text-white">סטטוס ייצור</h3>
          </div>
        ...
        <div className="col-span-12 lg:col-span-4 bg-slate-800/60 rounded-xl border border-slate-700/40 p-4">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="text-sm font-medium text-white">פולס מכירות</h3>
          </div>
        ...
        <div className="col-span-12 lg:col-span-4 bg-slate-800/60 rounded-xl border border-slate-700/40 p-4">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="text-sm font-medium text-white">התראות חיות</h3>
            {alerts.length > 0 && (
      ...
      <div className="grid grid-cols-12 gap-4">
        <div className="col-span-12 lg:col-span-6 bg-slate-800/60 rounded-xl border border-slate-700/40 p-4">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="text-sm font-medium text-white">רכש ואספקה</h3>
          </div>
          <div className="grid grid-cols-3 gap-3">
            ...
            <div className="bg-slate-900/50 rounded-lg p-3 text-center">
              <p className="text-xl font-bold text-white">{formatCurrency(procurement.totalValue)}</p>
          ...
          <div className="mt-3 grid grid-cols-2 gap-2">
            <div className="flex items-center gap-2 bg-slate-900/30 rounded-lg p-2">
              ...
              <div>
                <p className="text-sm font-bold text-white">{hr.totalEmployees}</p>
            ...
            <div className="flex items-center gap-2 bg-slate-900/30 rounded-lg p-2">
              ...
              <div>
                <p className="text-sm font-bold text-white">{projects.active}</p>
        ...
        <div className="col-span-12 lg:col-span-6 bg-slate-800/60 rounded-xl border border-slate-700/40 p-4">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="text-sm font-medium text-white">לוח KPI חי</h3>
          </div>
          <div className="grid grid-cols-4 sm:grid-cols-5 gap-2">
            {kpiGrid.map((kpi) => (
              <div key={kpi.key} className="bg-slate-900/50 rounded-lg p-2 text-center hover:bg-slate-900/80 transition-colors">
                ...
                <p className="text-sm font-bold text-white truncate">{formatValue(kpi.value, kpi.format)}</p>
      ...
      <div className="bg-slate-800/60 rounded-xl border border-slate-700/40 p-4">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h3 className="text-sm font-medium text-white">מפת חום פיננסית</h3>
        </div>
