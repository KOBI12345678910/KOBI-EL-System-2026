                  ...
                  <div>
                    ...
                    <div className="max-h-40 overflow-y-auto border border-slate-700 rounded-md p-2 space-y-1">
                      {rawMaterials.map(m => {
                        ...
                        return (
                          <label key={m.id} className="flex items-center gap-2 cursor-pointer text-sm text-slate-300 hover:text-white">
                            <input
                              type="checkbox"
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-slate-700/50 text-muted-foreground text-xs">
                  ...
                  <th className="text-left py-3 px-4 cursor-pointer hover:text-white" onClick={() => toggleSort("grossMargin")}>
                    מרג'ין גולמי {sortField === "grossMargin" ? (sortAsc ? "↑" : "↓") : ""}
                  </th>
                  <th className="text-left py-3 px-4 cursor-pointer hover:text-white" onClick={() => toggleSort("netMargin")}>
                    מרג'ין נקי {sortField === "netMargin" ? (sortAsc ? "↑" : "↓") : ""}
                  </th>
                  <th className="text-left py-3 px-4 cursor-pointer hover:text-white" onClick={() => toggleSort("grossProfit")}>
                  ...
                  return (
                    <tr key={item.id} className="border-b border-slate-700/30 hover:bg-slate-800/30 transition-colors">
                      <td className="py-3 px-4">
                        <div>
                          <p className="text-white font-medium">{item.projectName}</p>
