                ...
                return (
                  <motion.div key={role.id} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.03 }}
                    ...
                    <div className="flex items-center gap-2 pt-3 border-t border-border/50">
                      ...
                      {!role.isSystem && (
                        <button onClick={async () => { if (globalConfirm("למחוק תפקיד זה?")) deleteRoleMutation.mutate(role.id); }} className="p-2 hover:bg-destructive/10 rounded-lg transition-colors">
