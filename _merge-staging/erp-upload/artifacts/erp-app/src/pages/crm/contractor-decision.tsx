...
export default function ContractorDecisionPage() {
  ...
  const exVat = invoiceVal > 0 ? Math.round((invoiceVal / 1.17) * 100) / 100 : 0;
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <Card className="bg-gradient-to-br from-cyan-500/10 to-cyan-600/5 border-cyan-500/20">
          <CardContent className="p-4">
            ...
            <p className="text-lg sm:text-2xl font-bold text-white mt-2">{fmt(summary.totalSavings || 0)}</p>
        ...
        <Card className="bg-gradient-to-br from-green-500/10 to-green-600/5 border-green-500/20">
          <CardContent className="p-4">
            ...
            <p className="text-lg sm:text-2xl font-bold text-white mt-2">{summary.totalDeals || 0}</p>
        ...
        <Card className="bg-gradient-to-br from-blue-500/10 to-blue-600/5 border-blue-500/20">
          <CardContent className="p-4">
            ...
            <p className="text-lg sm:text-2xl font-bold text-white mt-2">{summary.percentRecommended || 0}</p>
        ...
        <Card className="bg-gradient-to-br from-purple-500/10 to-purple-600/5 border-purple-500/20">
          <CardContent className="p-4">
            ...
            <p className="text-lg sm:text-2xl font-bold text-white mt-2">{summary.sqmRecommended || 0}</p>
            ...
            {invoiceVal > 0 && (
              <div className="border-t border-border/50 pt-4 space-y-2">
                ...
                <div className="flex justify-between text-sm font-medium">
                  <span className="text-muted-foreground">סכום ללא מע״מ (÷1.17)</span>
                  <span className="text-white">{fmt(exVat)}</span>
                </div>
              ...
              <div className={`p-4 rounded-xl border ${calcResult.recommendation === "percent" ? "bg-blue-500/10 border-blue-500/20" : calcResult.recommendation === "sqm" ? "bg-purple-500/10 border-purple-500/20" : "bg-muted/10 border-gray-500/20"}`}>
                ...
                <div className="grid grid-cols-2 gap-2 text-sm">
                  <div>
                    ...
                    <span className="text-white mr-1">{fmt(calcResult.costByPercent)}</span>
                  </div>
                  <div>
                    <span className="text-muted-foreground">עלות לפי מ״ר:</span>
                    <span className="text-white mr-1">{fmt(calcResult.costBySqm)}</span>
                  </div>
                </div>
              ...
              <div className="p-4 bg-blue-500/5 border border-blue-500/20 rounded-xl">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-medium text-white">לפי אחוזים</span>
                  </div>
              ...
              <div className="p-4 bg-purple-500/5 border border-purple-500/20 rounded-xl">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-medium text-white">לפי מ״ר</span>
                  </div>
              ...
              <div className="p-4 bg-muted/5 border border-gray-500/20 rounded-xl">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-medium text-white">שווה</span>
                  </div>
                ...
                <tbody>
                  {quotes.map((q: any) => (
                    <tr key={q.id} className="border-b border-border/20 hover:bg-muted/30 transition-colors">
                      ...
                      <td className="py-2.5 px-2 font-medium text-white">{q.customerName || "—"}</td>
                ...
                <tbody>
                  {deals.map((d: any) => (
                    <tr key={d.id} className="border-b border-border/20 hover:bg-muted/30 transition-colors">
                      ...
                      <td className="py-2.5 px-2 font-medium text-white">{d.customerName || "—"}</td>
