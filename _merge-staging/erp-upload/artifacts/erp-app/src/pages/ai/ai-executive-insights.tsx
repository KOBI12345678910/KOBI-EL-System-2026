          ...
          {tab === "dashboard" && (
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                {[
                  { label: "דוחות שהופקו", value: fmt(metrics?.dailyMetrics?.reduce((s: number, d: any) => s + (d.actionsGenerated || 0), 0) || 52), icon: FileText, color: "from-blue-500/20 to-blue-600/10", text: "text-blue-400" },
                { label: "תחזיות שאושרו", value: "89%", icon: CheckCircle2, color: "from-green-500/20 to-green-600/10", text: "text-green-400" },
                { label: "KPIs במעקב", value: "24", icon: Target, color: "from-amber-500/20 to-amber-600/10", text: "text-amber-400" },
                { label: "המלצות אסטרטגיות", value: "15", icon: Brain, color: "from-purple-500/20 to-purple-600/10", text: "text-purple-400" },
                ].map((kpi, i) => (
          ...
          {tab === "settings" && (
            <div className="bg-card/5 border border-white/10 rounded-xl p-6 space-y-6">
              ...
              <div className="flex items-center justify-between p-3 bg-card/5 rounded-lg">
                  ...
                  <button onClick={() => updateSetting("includeForecasts", !settings.includeForecasts)} className={`w-12 h-6 rounded-full transition ${settings.includeForecasts ? "bg-green-500" : "bg-gray-600"} relative`}>
              ...
              <div className="flex items-center justify-between p-3 bg-card/5 rounded-lg">
                  ...
                  <button onClick={() => updateSetting("includeBenchmarks", !settings.includeBenchmarks)} className={`w-12 h-6 rounded-full transition ${settings.includeBenchmarks ? "bg-green-500" : "bg-gray-600"} relative`}>
              ...
              <div className="flex items-center justify-between p-3 bg-card/5 rounded-lg">
                  ...
                  <button onClick={() => updateSetting("kpiAlerts", !settings.kpiAlerts)} className={`w-12 h-6 rounded-full transition ${settings.kpiAlerts ? "bg-green-500" : "bg-gray-600"} relative`}>
