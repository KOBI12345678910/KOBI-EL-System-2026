          ...
          {tab === "settings" && (
            <div className="bg-card/5 border border-white/10 rounded-xl p-6 space-y-6">
              ...
              <div className="flex items-center justify-between p-3 bg-card/5 rounded-lg">
                  ...
                  <button onClick={() => updateSetting("dynamicPricing", !settings.dynamicPricing)} className={`w-12 h-6 rounded-full transition ${settings.dynamicPricing ? "bg-green-500" : "bg-gray-600"} relative`}>
              ...
              <div className="flex items-center justify-between p-3 bg-card/5 rounded-lg">
                  ...
                  <button onClick={() => updateSetting("autoDiscount", !settings.autoDiscount)} className={`w-12 h-6 rounded-full transition ${settings.autoDiscount ? "bg-green-500" : "bg-gray-600"} relative`}>
              ...
              <div className="flex items-center justify-between p-3 bg-card/5 rounded-lg">
                  ...
                  <button onClick={() => updateSetting("includeAlternatives", !settings.includeAlternatives)} className={`w-12 h-6 rounded-full transition ${settings.includeAlternatives ? "bg-green-500" : "bg-gray-600"} relative`}>
