    ...
    <div className="space-y-4 sm:space-y-6" dir="rtl">
      <div className="flex justify-between items-start flex-wrap gap-4">
        ...
        <div className="flex gap-2 flex-wrap items-center">
          ...
          <button onClick={() => printPage("דוח רווח והפסד")} className="flex items-center gap-1.5 bg-slate-700 text-white px-3 py-2 rounded-lg hover:bg-slate-600 text-sm"><Printer size={16} /> הדפסה</button>
          <button onClick={() => sendByEmail("דוח רווח והפסד", generateEmailBody("רווח והפסד", allItems, { account_number: "מספר", account_name: "חשבון", amount: "סכום" }))} className="flex items-center gap-1.5 bg-slate-700 text-white px-3 py-2 rounded-lg hover:bg-slate-600 text-sm"><Send size={16} /> שליחה</button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
        <div className="bg-card border border-border/50 rounded-2xl p-5">
          <h3 className="text-sm font-bold text-white mb-4">רשומות קשורות</h3>
          <RelatedRecords entityType="profit-loss" entityId="dashboard" />
        </div>
        <div className="bg-card border border-border/50 rounded-2xl p-5">
          <h3 className="text-sm font-bold text-white mb-4">היסטוריית פעילות</h3>
