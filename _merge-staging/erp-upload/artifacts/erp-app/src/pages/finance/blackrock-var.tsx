    ...
    <div className="space-y-4" dir="rtl">
      <div className="flex items-center justify-between flex-wrap gap-2">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h1 className="text-xl font-bold text-white">Value at Risk — ניתוח מוסדי</h1>
              ...
              <table className="w-full text-xs">
                ...
                <tbody>
                  ...
                  <tr className="bg-slate-800/30 border-t border-slate-700/50">
                    <td className="p-2 text-white font-bold">סה"כ</td>
                    <td className="p-2 text-white font-bold font-mono">100%</td>
                    <td className="p-2 text-white font-bold font-mono">{fmt(3330000)}</td>
                    ...
                    <td className="p-2 text-white font-mono">1.00</td>
              ...
              <table className="w-full text-xs">
                ...
                <tbody>
                  {EXTREME.map((e, i) => (
                    <tr key={i} className="border-b border-slate-800/40 hover:bg-slate-800/20">
                      <td className="p-2 text-muted-foreground">{i + 1}</td>
                      <td className="p-2 text-white font-medium">{e.name}</td>
