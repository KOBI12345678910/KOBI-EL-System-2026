        ...
        <div className="rounded-xl border border-slate-700/50 bg-slate-800/40 p-4">
          <div className="flex items-center justify-between flex-wrap gap-4 text-sm">
            ...
            <div className="flex items-center gap-6 text-xs text-muted-foreground">
              <div>אנומליות השבוע: <span className="text-white font-medium">{weekCount}</span></div>
                  ...
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <h3 className="font-bold text-sm text-white mb-1">{a.title}</h3>
                        ...
                        <div className="flex flex-wrap items-center gap-4 text-xs">
                          ...
                          {a.supplier_name && (
                            <div>
                              ...
                              <span className="text-white">{a.supplier_name}</span>
                            </div>
                          )}
                          {a.payment_date && (
                            <div>
                              <span className="text-muted-foreground">תאריך תשלום: </span>
                              <span className="text-white">{new Date(a.payment_date).toLocaleDateString("he-IL")}</span>
                            </div>
                          )}
                          {a.recommendation && (
            ...
            {[
              ...
              return (
                <div key={i} className="flex items-start gap-2 rounded-lg bg-slate-900/50 px-3 py-2">
                  ...
                  <div>
                    <div className="text-xs font-medium text-white">{ANOMALY_TYPE_LABELS[item.type]}</div>
