...
function generateShipments(): Shipment[] {
  ...
  return suppliers.map((supplier, i) => {
    ...
    const vat = Math.floor((goods + freight + insurance + customs) * 0.17);
    const broker = 3500;
    const handling = 2200;
    const inland = 1800;
...
export default function ImportManagementPage() {
  ...
  const { data: shipmentsRaw } = useQuery({
                  ...
                  {shipments.map((s) => (
                    <TableRow key={s.id}>
                      ...
                      <TableCell className="text-center">
                        <Badge className={`${statusColors[s.status]} text-white`}>
                ...
                <div className="bg-muted/30 rounded-xl p-6 space-y-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between text-lg font-bold border-t-2 pt-3 text-primary">
                      ...
                      <span className="font-mono">$137,376</span>
                    </div>
                    <div className="flex justify-between text-sm text-muted-foreground">
                      <span>עלות ליחידה</span>
                      <span className="font-mono">$1,373.76</span>
                    </div>
                    <div className="flex justify-between text-sm text-muted-foreground">
