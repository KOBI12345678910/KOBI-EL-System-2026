        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <button
              ...
              className="bg-gradient-to-r from-amber-500 to-orange-600 text-white px-4 py-2 rounded-xl flex items-center gap-2 hover:opacity-90 transition shadow-md text-sm flex-shrink-0"
            >
                ...
                <Card className="p-4 border-primary/30">
                  ...
                  <div className="flex gap-2 mt-4">
                    <button
                      ...
                      className="flex-1 bg-amber-600 text-white rounded-lg py-2 hover:bg-amber-700 disabled:opacity-50 flex items-center justify-center gap-2 text-sm"
                    >
