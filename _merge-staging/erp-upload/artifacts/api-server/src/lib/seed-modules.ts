...
async function seedFinanceMissingEntities() {
  ...
  if (expenseEntityId) {
    await ensureFields(expenseEntityId, [
      ...
      { name: "אחוז מע\"מ", slug: "vat_percent", fieldType: "number", sortOrder: 23, groupName: "מס", defaultValue: "17" },
  ...
  await ensureFields(companySettingsId, [
    ...
    { name: "אחוז מע\"מ ברירת מחדל", slug: "default_vat", fieldType: "number", sortOrder: 6, groupName: "הגדרות כספיות", defaultValue: "17" },
...
async function seedAccountingNewEntities() {
  ...
  await ensureFields(taxesId, [
    ...
    { name: "שיעור מס (%)", slug: "tax_rate", fieldType: "number", sortOrder: 3, isRequired: true, groupName: "פרטי מס", showInList: true, defaultValue: "17" },
