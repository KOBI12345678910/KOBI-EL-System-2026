...
import { Shield, LogIn, Factory, AlertCircle, KeyRound, ArrowRight, CheckCircle2 } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 flex items-center justify-center p-4" dir="rtl">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-xl sm:text-3xl font-bold text-white">טכנו-כל עוזי</h1>
        ...
        <Card className="bg-slate-900/80 border-slate-700/50 backdrop-blur-xl">
          <CardHeader className="pb-4">
            <div className="flex items-center gap-2 justify-center text-white">
              {mode === "login" ? <LogIn className="w-5 h-5 text-blue-400" /> : <KeyRound className="w-5 h-5 text-amber-400" />}
              <span className="font-semibold text-lg">{mode === "login" ? "התחברות למערכת" : "שחזור סיסמה"}</span>
            </div>
          </CardHeader>
                ...
                <form onSubmit={handleLogin} className="space-y-4">
                  <div>
                    ...
                    <Input id="login-user" value={loginForm.username}
                      ...
                      className="bg-slate-800/50 border-slate-600 text-white mt-1" placeholder="הכנס שם משתמש" required autoFocus
                  ...
                  <div>
                    ...
                    <Input id="login-pass" type="password" value={loginForm.password}
                      ...
                      className="bg-slate-800/50 border-slate-600 text-white mt-1" placeholder="הכנס סיסמה" required
              ...
              <>
                ...
                {recoveredPassword ? (
                  <div className="p-4 rounded-lg bg-amber-500/10 border border-amber-500/40 text-center space-y-2">
                    ...
                    <p className="text-white text-xl font-mono tracking-widest select-all bg-slate-800 rounded px-3 py-2 border border-slate-600" dir="ltr">{recoveredPassword}</p>
                  ...
                  <form onSubmit={handleForgotPassword} className="space-y-4">
                    <div>
                      ...
                      <Input id="forgot-email" type="text" value={forgotEmail}
                        ...
                        className="bg-slate-800/50 border-slate-600 text-white mt-1" placeholder="שם משתמש או כתובת אימייל" dir="rtl" required autoFocus />
                    </div>
