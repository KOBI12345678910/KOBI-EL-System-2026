...
export default function VendorEvaluationPage() {
  ...
  const handleSave = async () => {
    setSaving(true);
    try {
      await authFetch(`${API}/procurement-sap/vendor-evaluations`, {
        method: "POST",
  ...
  return (
    <div className="p-6 space-y-6" dir="rtl">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-gray-100">הערכת ספקים</h1>
      ...
      {showForm && (
        <div className="rounded-xl border border-gray-700/50 bg-gray-800/30 p-6 space-y-4">
          <h2 className="text-lg font-semibold text-white">יצירת הערכה חדשה</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div>
              <label className="block text-sm text-gray-300 mb-1">שם ספק *</label>
              <input
                type="text" className="w-full rounded-lg border border-gray-600 bg-gray-700/50 px-3 py-2 text-gray-200"
            ...
            <div>
              ...
              <input
                type="date" className="w-full rounded-lg border border-gray-600 bg-gray-700/50 px-3 py-2 text-gray-200"
