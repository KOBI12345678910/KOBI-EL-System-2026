...
const PayrollEnginePage = lazyPage(() => import("@/pages/payroll"));
const BomProductsPage = lazyPage(() => import("@/pages/bom-products"));
const LeadScoringPage = lazyPage(() => import("@/pages/lead-scoring"));
...
const AIEngineLeadScoringPage = lazyPage(() => import("@/pages/ai-engine/lead-scoring"));
    ...
    <Layout>
      ...
      <Suspense fallback={<PageLoader />}>
        <Switch>
          ...
          <Route path="/ai-engine/lead-scoring" component={AIEngineLeadScoringPage} />
          ...
          <Route path="/crm/lead-scoring" component={LeadScoringPage} />
