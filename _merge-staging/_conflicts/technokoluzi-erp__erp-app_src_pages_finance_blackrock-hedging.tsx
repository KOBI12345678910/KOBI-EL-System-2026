    ...
    <div className="space-y-4" dir="rtl">
      <div className="flex items-center justify-between flex-wrap gap-2">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h1 className="text-xl font-bold text-white">Hedging & Risk Mitigation</h1>
                ...
                <tbody>
                  {STRATEGIES.map((s, i) => (
                    <tr key={i} className="border-b border-slate-800/40 hover:bg-slate-800/20">
                      <td className="p-2.5 text-white font-medium">{s.name}</td>
                  ...
                  <tr className="bg-slate-800/30 border-t border-slate-700/50">
                    <td className="p-2.5 text-white font-bold">Portfolio Total</td>
                    ...
                    return (
                      <div key={i}>
                        <div className="flex items-center justify-between mb-1">
                          <span className="text-xs text-white">{c.risk}</span>
