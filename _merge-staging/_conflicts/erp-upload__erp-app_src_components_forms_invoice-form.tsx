...
const typeLabels = { invoice: "חשבונית", receipt: "קבלה", credit_note: "זיכוי" };
const statusLabels = { draft: "טיוטה", sent: "נשלח", paid: "שולם", overdue: "באיחור", cancelled: "בוטל" };
const paymentMethodLabels = { cash: "מזומן", check: "צ'ק", bank_transfer: "העברה בנקאית", credit_card: "כרטיס אשראי", paypal: "PayPal" };

export default function InvoiceForm({ open, onClose, onSave, invoice, customers = [], products = [] }) {
            ...
            <SheetContent className="w-full sm:max-w-2xl overflow-y-auto" side="left">
                <SheetHeader className="mb-6">
                    <SheetTitle className="text-xl">
                        {invoice ? 'עריכת חשבונית' : 'חשבונית חדשה'}
                    </SheetTitle>
                </SheetHeader>
                        ...
                        <div className="space-y-3">
                            ...
                            {formData.items.length === 0 && (
                                <div className="text-center py-8 text-slate-400">
                                    לחץ על "הוסף פריט" להוספת פריטים לחשבונית
                                </div>
                            )}
                        </div>
                    </div>
