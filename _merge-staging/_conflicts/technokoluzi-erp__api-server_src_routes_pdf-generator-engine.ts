    ...
    const priceQuoteHTML = `
      <div class="document-container">
        ...
        <div class="totals-section">
          ...
          <div class="total-row vat-row"><span>מע"מ (18%):</span><span class="number-col">₪{{vat_amount}}</span></div>
    ...
    const contractHTML = `
      <div class="document-container">
        ...
        <div style="margin:20px 0; font-size:13px; line-height:1.8;">
          ...
          <div style="margin:10px 0;">
            <strong>2. מחיר:</strong> סה"כ ₪{{grand_total}} כולל מע"מ 18%.
          </div>
          <div style="margin:10px 0;">
    ...
    const monthlyReportHTML = `
      <div class="document-container">
        ...
        <table class="items-table">
          <thead><tr><th>פריט</th><th class="number-col">סכום</th></tr></thead>
          <tbody>
            <tr><td>מע"מ עסקאות (18%)</td><td class="number-col">₪{{vat_collected}}</td></tr>
            <tr><td>מע"מ תשומות (18%)</td><td class="number-col">₪{{vat_paid}}</td></tr>
