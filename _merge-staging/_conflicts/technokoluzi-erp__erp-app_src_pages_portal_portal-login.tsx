    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-blue-900 flex items-center justify-center p-4" dir="rtl">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-lg sm:text-2xl font-bold text-white">פורטל חיצוני</h1>
        ...
        <div className="bg-slate-800/50 backdrop-blur border border-slate-700/50 rounded-2xl p-6 shadow-xl">
          <div className="flex gap-2 mb-6">
            <button
              ...
              className={`flex-1 py-2 rounded-lg text-sm font-medium transition ${mode === "login" ? "bg-blue-600 text-white" : "bg-slate-700/50 text-muted-foreground hover:text-white"}`}
            >
              התחברות
            </button>
            <button
              onClick={() => { setMode("register"); setError(""); }}
              className={`flex-1 py-2 rounded-lg text-sm font-medium transition ${mode === "register" ? "bg-blue-600 text-white" : "bg-slate-700/50 text-muted-foreground hover:text-white"}`}
            >
              הרשמה
            </button>
          </div>
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 bg-slate-700/50 border border-slate-600 rounded-lg text-white placeholder-slate-500 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
            ...
            <div className="space-y-4">
              {!inviteInfo ? (
                ...
                <form onSubmit={handleRegister} className="space-y-4">
                  ...
                  <button
                    type="submit" disabled={loading}
                    className="w-full py-2.5 bg-green-600 hover:bg-green-700 text-white rounded-lg font-medium transition disabled:opacity-50"
                  >
                    {loading ? "נרשם..." : "הירשם"}
                  </button>
                </form>
