        ...
        {showForm && (
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <input className="bg-card/5 border border-white/10 rounded-lg p-2 text-white" placeholder="מזהה מוצר" value={form.product_id} onChange={(e) => setForm({ ...form, product_id: e.target.value })} />
              ...
              <input className="bg-card/5 border border-white/10 rounded-lg p-2 text-white" placeholder="מספר סריאלי" value={form.serial_number} onChange={(e) => setForm({ ...form, serial_number: e.target.value })} />
              ...
              <input className="bg-card/5 border border-white/10 rounded-lg p-2 text-white" placeholder="תאריך ייצור" type="date" value={form.production_date} onChange={(e) => setForm({ ...form, production_date: e.target.value })} />
              <input className="bg-card/5 border border-white/10 rounded-lg p-2 text-white" placeholder="מזהה הזמנת עבודה" value={form.work_order_id} onChange={(e) => setForm({ ...form, work_order_id: e.target.value })} />
