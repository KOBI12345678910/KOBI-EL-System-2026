      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <Card className="bg-gradient-to-br from-blue-500/10 to-blue-600/5 border-blue-500/20">
          <CardContent className="p-4">
            ...
            <p className="text-lg font-bold text-white">{recordsByModule.reduce((s: number, r: any) => s + r.total, 0)}</p>
        ...
        <Card className="bg-gradient-to-br from-green-500/10 to-green-600/5 border-green-500/20">
          <CardContent className="p-4">
            ...
            <p className="text-lg font-bold text-white">{totalCreated}</p>
        ...
        <Card className="bg-gradient-to-br from-cyan-500/10 to-cyan-600/5 border-cyan-500/20">
          <CardContent className="p-4">
            ...
            <p className="text-lg font-bold text-white">{totalUpdated}</p>
        ...
        <Card className="bg-gradient-to-br from-amber-500/10 to-amber-600/5 border-amber-500/20">
          <CardContent className="p-4">
            ...
            <p className="text-lg font-bold text-white">{approvals.pending || 0}</p>
          ...
          <Card className="bg-slate-900/50 border-slate-700/50">
            ...
            <CardContent>
              ...
              <div className="mt-4 pt-4 border-t border-slate-700/50">
                <p className="text-sm font-medium text-white mb-3">סיכום רשומות לפי מודול</p>
                <div className="space-y-2">
