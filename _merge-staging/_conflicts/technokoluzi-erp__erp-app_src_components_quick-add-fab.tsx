  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-6 left-6 z-50 w-14 h-14 rounded-full bg-emerald-600 text-white shadow-lg hover:bg-emerald-500 transition-all flex items-center justify-center hover:scale-105"
        title="הוסף נתונים"
      >
      ...
      {isOpen && !selectedEntity && (
        <div className="fixed bottom-24 left-6 z-50 bg-card border border-border rounded-2xl shadow-2xl w-80 max-h-[70vh] overflow-y-auto" dir="rtl">
