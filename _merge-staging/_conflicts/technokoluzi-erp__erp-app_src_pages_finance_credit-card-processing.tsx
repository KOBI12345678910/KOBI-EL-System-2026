                  ...
                  <tbody>
                    {items.map((item: any) => (
                      <tr key={item.id} className="border-b border-slate-800/50 hover:bg-slate-800/30">
                        ...
                        <td className="p-3 text-white font-medium">{fmt(Number(item.amount || 0))}</td>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
        <Card className="bg-slate-900/50 border-slate-700/50">
          <CardContent className="p-4">
            <h3 className="text-white font-bold mb-3">רשומות קשורות</h3>
            <RelatedRecords entityType="credit-card-transactions" entityId={null} />
          </CardContent>
        </Card>
        <Card className="bg-slate-900/50 border-slate-700/50">
          <CardContent className="p-4">
            <h3 className="text-white font-bold mb-3">היסטוריית פעולות</h3>
