...
export default function CrossModuleTransactions() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-gray-100 p-6" dir="rtl">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3">
              {uniqueFlows.map(flow => {
                ...
                return (
                  <div
                    key={flow}
                    className="bg-gray-900/50 border border-gray-700/30 rounded-lg p-3 cursor-pointer hover:border-cyan-500/40 transition"
        ...
        <div className="flex items-center gap-3 mb-4 flex-wrap">
          <div className="relative flex-1 min-w-[200px]">
            ...
            <input
              ...
              className="w-full bg-gray-800/60 border border-gray-700/50 rounded-lg pr-10 pl-4 py-2.5 text-sm text-gray-200 placeholder-gray-500 focus:border-cyan-500/50 focus:outline-none transition"
            />
          </div>
          ...
          <select
            ...
            className="bg-gray-800/60 border border-gray-700/50 rounded-lg px-3 py-2.5 text-sm text-gray-300 focus:outline-none focus:border-cyan-500/50"
          >
                      ...
                      <div className="px-5 pb-4 bg-gray-900/30">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                          ...
                          <div>
                            ...
                            <div className="text-xs text-gray-300 bg-gray-800/50 rounded-lg p-3 overflow-auto max-h-32 whitespace-pre-wrap" dir="rtl">
                              {tx.error_message ? (
