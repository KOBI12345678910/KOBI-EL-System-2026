    ...
    <div className="p-4 md:p-6 space-y-6" dir="rtl">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-lg font-bold text-white">פרופיל החברה</h2>
      ...
      <Card className="bg-[#1a1a2e]/80 border-[#2a2a3e]">
        <CardContent className="p-6">
          <h3 className="text-sm font-semibold text-blue-400 border-b border-[#2a2a3e] pb-2 mb-4 flex items-center gap-2">
            <Image className="h-4 w-4" />
            לוגו החברה
          </h3>
          <div className="flex items-center gap-6">
            <div className="w-24 h-24 rounded-xl border-2 border-dashed border-[#2a2a3e] flex items-center justify-center overflow-hidden bg-[#0a0a1a]">
              {profile.logoUrl ? (
            ...
            <div className="flex flex-col gap-2">
              ...
              <Button
                variant="outline"
                className="gap-2 border-[#2a2a3e] text-white hover:bg-[#2a2a3e]"
        ...
        <CardContent className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div>
              ...
              <Input value={profile.companyName} onChange={e => upd("companyName", e.target.value)} className="bg-[#0a0a1a] border-[#2a2a3e] text-white mt-1" />
            </div>
            <div>
              <Label className="text-muted-foreground text-xs">שם החברה (אנגלית)</Label>
              <Input value={profile.companyNameEn} onChange={e => upd("companyNameEn", e.target.value)} className="bg-[#0a0a1a] border-[#2a2a3e] text-white mt-1" dir="ltr" />
            </div>
            <div>
              <Label className="text-muted-foreground text-xs flex items-center gap-1"><Hash className="h-3 w-3" />מספר עוסק מורשה</Label>
              <Input value={profile.taxId} onChange={e => upd("taxId", e.target.value)} className="bg-[#0a0a1a] border-[#2a2a3e] text-white mt-1" dir="ltr" />
            </div>
            <div>
              <Label className="text-muted-foreground text-xs flex items-center gap-1"><Factory className="h-3 w-3" />ענף תעשייה</Label>
              <Input value={profile.industry} onChange={e => upd("industry", e.target.value)} className="bg-[#0a0a1a] border-[#2a2a3e] text-white mt-1" />
            </div>
            <div>
              <Label className="text-muted-foreground text-xs flex items-center gap-1"><Calendar className="h-3 w-3" />שנת הקמה</Label>
              <Input value={profile.foundedYear} onChange={e => upd("foundedYear", e.target.value)} className="bg-[#0a0a1a] border-[#2a2a3e] text-white mt-1" dir="ltr" />
            </div>
            <div>
              <Label className="text-muted-foreground text-xs flex items-center gap-1"><Users className="h-3 w-3" />מספר עובדים</Label>
              <Input value={profile.employeeCount} onChange={e => upd("employeeCount", e.target.value)} type="number" className="bg-[#0a0a1a] border-[#2a2a3e] text-white mt-1" dir="ltr" />
            </div>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="lg:col-span-2">
              ...
              <Input value={profile.address} onChange={e => upd("address", e.target.value)} className="bg-[#0a0a1a] border-[#2a2a3e] text-white mt-1" />
            </div>
            <div>
              <Label className="text-muted-foreground text-xs">עיר</Label>
              <Input value={profile.city} onChange={e => upd("city", e.target.value)} className="bg-[#0a0a1a] border-[#2a2a3e] text-white mt-1" />
            </div>
            <div>
              <Label className="text-muted-foreground text-xs">מיקוד</Label>
              <Input value={profile.zipCode} onChange={e => upd("zipCode", e.target.value)} className="bg-[#0a0a1a] border-[#2a2a3e] text-white mt-1" dir="ltr" />
            </div>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div>
              ...
              <Input value={profile.phone} onChange={e => upd("phone", e.target.value)} className="bg-[#0a0a1a] border-[#2a2a3e] text-white mt-1" dir="ltr" />
            </div>
            <div>
              <Label className="text-muted-foreground text-xs">פקס</Label>
              <Input value={profile.fax} onChange={e => upd("fax", e.target.value)} className="bg-[#0a0a1a] border-[#2a2a3e] text-white mt-1" dir="ltr" />
            </div>
            <div>
              <Label className="text-muted-foreground text-xs flex items-center gap-1"><Mail className="h-3 w-3" />אימייל</Label>
              <Input value={profile.email} onChange={e => upd("email", e.target.value)} className="bg-[#0a0a1a] border-[#2a2a3e] text-white mt-1" dir="ltr" />
            </div>
            <div>
              <Label className="text-muted-foreground text-xs flex items-center gap-1"><Globe className="h-3 w-3" />אתר אינטרנט</Label>
              <Input value={profile.website} onChange={e => upd("website", e.target.value)} className="bg-[#0a0a1a] border-[#2a2a3e] text-white mt-1" dir="ltr" />
            </div>
          </div>
        </CardContent>
      </Card>
