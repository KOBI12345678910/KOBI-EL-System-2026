  ...
  return (
    <div className="p-6 space-y-6" dir="rtl">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-gray-100">דשבורד רכש</h1>
      ...
      {showForm && (
        <div className="rounded-xl border border-gray-700/50 bg-gray-800/30 p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-1">order_number</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-1">order_date</label>
                <input
                  type="text"
                  className="w-full rounded-lg border border-gray-600 bg-gray-700/50 px-3 py-2 text-gray-200"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-1">expected_delivery</label>
                <input
                  type="text"
                  className="w-full rounded-lg border border-gray-600 bg-gray-700/50 px-3 py-2 text-gray-200"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-1">total_amount_cents</label>
                <input
                  type="number"
                  className="w-full rounded-lg border border-gray-600 bg-gray-700/50 px-3 py-2 text-gray-200"
                  placeholder="total_amount_cents"
          ...
          <table className="w-full">
            <thead className="bg-gray-800/60 border-b border-gray-700/50">
              <tr>
                ...
                <th className="px-4 py-3 text-right text-sm font-medium text-gray-300">order_number</th>
                <th className="px-4 py-3 text-right text-sm font-medium text-gray-300">supplier_id</th>
                <th className="px-4 py-3 text-right text-sm font-medium text-gray-300">order_date</th>
                <th className="px-4 py-3 text-right text-sm font-medium text-gray-300">expected_delivery</th>
                <th className="px-4 py-3 text-right text-sm font-medium text-gray-300">status</th>
                <th className="px-4 py-3 text-right text-sm font-medium text-gray-300">total_amount_cents</th>
            ...
            <tbody className="divide-y divide-gray-700/30">
              {items.map(item => (
                ...
                <td className="px-4 py-3 text-sm text-gray-300">{item.order_number}</td>
                <td className="px-4 py-3 text-sm text-gray-300">{item.supplier_id}</td>
                <td className="px-4 py-3 text-sm text-gray-300">{item.order_date}</td>
                <td className="px-4 py-3 text-sm text-gray-300">{item.expected_delivery}</td>
                <td className="px-4 py-3 text-sm text-gray-300">{item.status}</td>
                <td className="px-4 py-3 text-sm text-gray-300">{item.total_amount_cents}</td>
