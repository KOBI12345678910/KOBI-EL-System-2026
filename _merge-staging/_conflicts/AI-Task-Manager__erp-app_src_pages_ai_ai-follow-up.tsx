          ...
          {tab === "settings" && (
            <div className="bg-card/5 border border-white/10 rounded-xl p-6 space-y-6">
              ...
              <div className="flex items-center justify-between p-3 bg-card/5 rounded-lg">
                  ...
                  <button onClick={() => updateSetting("autoSchedule", !settings.autoSchedule)} className={`w-12 h-6 rounded-full transition ${settings.autoSchedule ? "bg-green-500" : "bg-muted"} relative`}>
