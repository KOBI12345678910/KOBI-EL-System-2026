...
/** Israeli standard VAT rate — 18% effective 2026-01-01 (was 17% until 2025-12-31) */
export const IL_VAT_RATE = 0.18;
/** Prior Israeli VAT rate (retained for historical invoice calculations) */
...
export class PricingEngine {
  ...
  /** Add Israeli VAT (18%, effective 2026-01-01; 17% before) to a net amount */
