...
export async function seedAllTables() {
  ...
  try {
    ...
    await run("budgets", `INSERT INTO budgets (budget_name, category, department, fiscal_year, fiscal_month, budgeted_amount, actual_amount, status, notes, created_at, updated_at) VALUES
      ('תקציב ייצור 2026', 'תפעול', 'ייצור', 2026, 1, 500000000, 120000000, 'active', 'תקציב שנתי מחלקת ייצור', NOW(), NOW()),
      ('תקציב חומרי גלם', 'רכש', 'רכש', 2026, 1, 300000000, 85000000, 'active', 'תקציב חומרי גלם שנתי', NOW(), NOW()),
      ('תקציב שכר', 'שכר', 'משאבי אנוש', 2026, 1, 400000000, 100000000, 'active', 'תקציב שכר שנתי', NOW(), NOW()),
      ('תקציב שיווק', 'שיווק', 'שיווק', 2026, 1, 50000000, 12000000, 'active', 'תקציב שיווק ופרסום', NOW(), NOW()),
      ('תקציב תחזוקה', 'תחזוקה', 'תחזוקה', 2026, 1, 80000000, 15000000, 'active', 'תקציב תחזוקת ציוד ומכונות', NOW(), NOW()),
      ('תקציב IT', 'טכנולוגיה', 'מערכות מידע', 2026, 1, 30000000, 8000000, 'active', 'תקציב מערכות ותוכנה', NOW(), NOW())
    ON CONFLICT DO NOTHING`);
