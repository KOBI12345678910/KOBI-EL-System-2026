...
function validateEnv() {
    ...
    if (process.env.NODE_ENV === 'production' &&
        ...
        console.error('TECHNO-KOL OPS refuses to boot: JWT_SECRET is set to a default/known value in production.');
...
try {
    ...
    console.warn('[security] express-rate-limit not installed — run `npm install express-rate-limit`. Falling back to no-op.');
