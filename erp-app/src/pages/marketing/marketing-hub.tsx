      ...
      <div className="flex items-center justify-between">
        <div>
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-lg sm:text-2xl font-bold text-white">Marketing Hub</h1>
          </div>
          <p className="text-muted-foreground text-sm mt-1 mr-10">מרכז שיווק מרכזי — ניהול קמפיינים, פלטפורמות וביצועים</p>
        </div>
        <div className="flex gap-2">
          <button onClick={load} className="flex items-center gap-2 px-3 py-2 bg-gray-700 hover:bg-gray-600 text-white rounded-lg text-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
        {[
          ...
          <Link key={i} href={item.href}>
            <div className="bg-gray-800/50 border border-gray-700 rounded-xl p-4 hover:bg-gray-700/50 cursor-pointer transition-colors group">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-xl">
        <div className="p-4 border-b border-gray-800 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-white font-semibold">קמפיינים</h2>
            <span className="text-xs text-muted-foreground bg-gray-800 px-2 py-0.5 rounded-full">{filtered.length}</span>
          </div>
          <div className="flex gap-2">
            <div className="relative">
              ...
              <input
                ...
                placeholder="חיפוש..."
                className="bg-gray-800 border border-gray-700 rounded-lg pr-9 pl-3 py-1.5 text-sm text-white w-48"
              />
            </div>
            <select
              value={filterStatus}
            ...
            <Link href="/marketing/campaigns">
              <button className="flex items-center gap-1 px-3 py-1.5 bg-purple-600 hover:bg-purple-700 text-white rounded-lg text-sm">
                <Plus size={14} />חדש
              </button>
            </Link>
          </div>
