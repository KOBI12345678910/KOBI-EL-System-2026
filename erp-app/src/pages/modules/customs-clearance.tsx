...
import {
  ...
  ClipboardCheck, FileCheck, Truck, Globe, ArrowUpDown
} from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50" dir="rtl">
      <div className="max-w-7xl mx-auto p-4 md:p-6 space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <button onClick={openCreate} className="flex items-center gap-2 bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-all shadow-lg">
                      ...
                      return (
                        <motion.div key={c.id} initial={{ opacity: 0 }} animate={{ opacity: 1 }}
                          ...
                          <div className="flex gap-1 mt-3 pt-3 border-t border-slate-100">
                            ...
                            <button onClick={async () => { if (globalConfirm("למחוק תיק זה?")) deleteMut.mutate(c.id); }} className="flex-1 flex items-center justify-center gap-1 text-red-600 hover:bg-red-50 rounded-lg py-1.5 text-sm"><Trash2 size={14} /> מחיקה</button>
                          </div>
                        </motion.div>
                      );
                    })}
