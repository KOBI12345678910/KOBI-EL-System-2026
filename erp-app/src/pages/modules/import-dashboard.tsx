    ...
    <div className="min-h-screen" dir="rtl">
      <div className="p-6 space-y-6 max-w-[1600px] mx-auto">
        <div className="flex items-center justify-between">
          ...
          <button onClick={() => navigate("/builder/data/45")} className="flex items-center gap-2 px-5 py-2.5 bg-blue-600 hover:bg-blue-500 text-white rounded-xl font-medium transition-colors">
          ...
          <div className="bg-[#1a1d23] border border-gray-800 rounded-2xl p-5">
            ...
            {importOrders.length === 0 ? (
              <div className="text-center py-8">
                ...
                <button onClick={() => navigate("/builder/data/45")} className="flex items-center gap-2 mx-auto px-4 py-2 bg-blue-600 hover:bg-blue-500 text-white rounded-lg text-sm">
              ...
              <div className="space-y-2">
                {importOrders.slice(0, 5).map((o: any, i: number) => (
                  <div key={o.id || i} className="flex items-center justify-between bg-[#12141a] rounded-xl p-3">
                    <div className="flex items-center gap-3">
                      <Ship className="w-4 h-4 text-blue-400" />
                      <span className="text-white text-sm">{getVal(o, "order_number") || getVal(o, "orderNumber") || `הזמנה #${o.id}`}</span>
                    </div>
          ...
          <div className="bg-[#1a1d23] border border-gray-800 rounded-2xl p-5">
            ...
            {shipments.length === 0 ? (
              <div className="text-center py-8">
                ...
                <button onClick={() => navigate("/builder/data/47")} className="flex items-center gap-2 mx-auto px-4 py-2 bg-cyan-600 hover:bg-cyan-500 text-white rounded-lg text-sm">
              ...
              <div className="space-y-2">
                {shipments.slice(0, 5).map((s: any, i: number) => (
                  <div key={s.id || i} className="flex items-center justify-between bg-[#12141a] rounded-xl p-3">
                    <div className="flex items-center gap-3">
                      <Navigation className="w-4 h-4 text-cyan-400" />
                      <span className="text-white text-sm">{getVal(s, "tracking_number") || getVal(s, "trackingNumber") || `משלוח #${s.id}`}</span>
                    </div>
