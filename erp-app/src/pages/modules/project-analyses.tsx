...
import { FolderKanban, Plus, Search, TrendingUp, DollarSign, AlertTriangle, CheckCircle, XCircle, Trash2 } from "lucide-react";
            ...
            >
              <CardContent className="p-4">
                <div className="flex items-center justify-between mb-3">
                  <h3 className="text-white font-medium truncate">{item.projectName}</h3>
                ...
                <div className="mt-3 pt-3 border-t border-slate-700/50 flex justify-between items-center">
                  ...
                  <Button
                    ...
                    onClick={async (e) => {
                      e.stopPropagation();
                      if (globalConfirm("למחוק ניתוח זה?")) deleteMutation.mutate(item.id);
                    }}
                  >
