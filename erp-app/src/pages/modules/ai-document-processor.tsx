    ...
    <div className="space-y-4" dir="rtl">
      ...
      <div className="bg-card border border-border rounded-xl p-4 space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          ...
          <div>
            <span className="text-[10px] text-muted-foreground">מע"מ (18%)</span>
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        {extractedDocsCount > 0 && (
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 bg-emerald-600 text-white rounded-xl text-sm font-semibold hover:bg-emerald-500 transition-colors disabled:opacity-50"
          >
      ...
      <div className="flex gap-2 border-b border-border mb-4">
        {[
          ...
          <button
            ...
            className={`px-4 py-2 text-sm font-medium border-b-2 transition-colors ${detailTab === tab.id ? "border-violet-500 text-violet-400" : "border-transparent text-muted-foreground hover:text-white"}`}
          >
            {tab.label}
          </button>
        ))}
