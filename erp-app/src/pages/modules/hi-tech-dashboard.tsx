  ...
  return (
    ...
    >
      <motion.div
        ...
        className="w-full max-w-3xl h-[80vh] bg-[#0d0f14] border border-gray-800 rounded-2xl flex flex-col overflow-hidden shadow-2xl"
        dir="rtl"
      >
        <div className={`flex items-center justify-between px-5 py-4 border-b border-gray-800 ${agent.headerBg}`}>
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-bold text-white">{agent.nameHe}</h3>
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={onClose} className="p-2 text-muted-foreground hover:text-white hover:bg-card/5 rounded-lg transition-colors">
              <X className="w-4 h-4" />
            </button>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          {messages.length === 0 && (
            <div className="flex flex-col items-center justify-center h-full gap-6">
              ...
              <div className="text-center">
                <h4 className="text-white font-bold text-lg mb-2">{agent.nameHe}</h4>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 max-w-lg">
                  {agent.suggestions.map((s, i) => (
                    <button
                      ...
                      className="text-right p-3 bg-[#1a1d23] border border-gray-800 rounded-xl text-sm text-gray-300 hover:border-gray-600 hover:text-white transition-colors"
                    >
          ...
          {messages.map((msg, i) => (
            <motion.div key={i} initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} className={`flex gap-3 ${msg.role === "user" ? "flex-row-reverse" : ""}`}>
              ...
              <div className={`max-w-[80%] rounded-xl px-4 py-3 ${msg.role === "user" ? "bg-blue-600/20 border border-blue-600/30" : "bg-[#1a1d23] border border-gray-800"}`}>
                <p className="text-gray-200 text-sm whitespace-pre-wrap leading-relaxed">{msg.content}</p>
          ...
          {isLoading && (
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex gap-3">
              ...
              <div className="bg-[#1a1d23] border border-gray-800 rounded-xl px-4 py-3">
          ...
          <div className="flex gap-3 items-end">
            <div className="flex-1">
              <textarea
                ...
                className="w-full bg-[#1a1d23] border border-gray-700 rounded-xl px-4 py-3 text-white placeholder-gray-500 resize-none focus:outline-none min-h-[48px] max-h-[150px] text-sm"
                rows={1}
            ...
            <button
              ...
              className="flex-shrink-0 w-12 h-12 rounded-xl flex items-center justify-center transition-colors disabled:bg-gray-700 disabled:cursor-not-allowed text-white"
...
function AgentCard({ agent, onActivate }: { agent: (typeof AGENT_DEFINITIONS)[0]; onActivate: () => void }) {
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -3 }}
      className={`relative bg-[#0d1117] border ${agent.borderColor} rounded-2xl overflow-hidden flex flex-col group cursor-pointer`}
    ...
    >
      ...
      <div className={`flex items-center justify-between px-5 py-4 ${agent.headerBg} border-b ${agent.borderColor}`}>
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-bold text-white text-sm">{agent.nameHe}</h3>
  ...
  return (
    <div className="min-h-screen bg-[#080a0f] text-white" dir="rtl">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-6 py-6 space-y-8">
        ...
        <div className="flex items-start justify-between">
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <h1 className="text-2xl font-black text-white tracking-tight">דאשבורד הייטק — טכנו-כל עוזי</h1>
          ...
          {topStats.map((stat, i) => {
            ...
            return (
              ...
              >
                ...
                <div className="font-black text-2xl text-white mb-0.5 tabular-nums">{stat.value}</div>
            ...
            {dataStats.map((item, i) => {
              ...
              return (
                <motion.button
                  ...
                  className="bg-[#0d1117] border border-gray-800 rounded-xl p-3 text-right hover:border-gray-600 transition-colors group"
                >
                  ...
                  <div className="font-bold text-xl text-white tabular-nums">{item.value}</div>
        ...
        <div>
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg font-bold text-white">סוכני AI מתמחים</h2>
        ...
        {logs.length > 0 && (
          <div className="bg-[#0d1117] border border-gray-800 rounded-2xl overflow-hidden">
            <div className="flex items-center gap-3 px-5 py-4 border-b border-gray-800">
              ...
              <h3 className="font-bold text-white text-sm">פעולות אחרונות של סוכני AI</h3>
