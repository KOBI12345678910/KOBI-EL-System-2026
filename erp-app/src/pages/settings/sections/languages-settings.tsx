            ...
            {locales.map((locale) => (
              <Card key={locale.id} className="p-4 flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {!locale.isDefault && (
                    <Button
                      onClick={async () => { if (globalConfirm("למחוק שפה זו?")) deleteLocaleMutation.mutate(locale.id); }}
                    ...
                    <tr key={t.id} className="border-b border-border/50 hover:bg-muted/20">
                      ...
                      <td className="p-3">
                        <div className="flex items-center gap-1">
                          ...
                          <button onClick={async () => { if (globalConfirm("למחוק?")) deleteTranslationMutation.mutate(t.id); }} className="p-1 hover:bg-destructive/10 rounded">
