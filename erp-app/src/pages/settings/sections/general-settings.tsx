...
const EMPTY: GeneralSettings = {
  ...
  language: "he", vatRate: "18", fiscalYearStart: "01", workWeekStart: "sunday", decimalPlaces: "2",
};
    ...
    <div className="p-4 md:p-6 space-y-6" dir="rtl">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-lg font-bold text-white">הגדרות כלליות</h2>
      ...
      <Card className="bg-[#1a1a2e]/80 border-[#2a2a3e]">
        <CardContent className="p-6">
          <h3 className="text-sm font-semibold text-emerald-400 border-b border-[#2a2a3e] pb-2 mb-4 flex items-center gap-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div>
              ...
              <select value={settings.currency} onChange={e => upd("currency", e.target.value)}
                className="w-full bg-[#0a0a1a] border border-[#2a2a3e] rounded-md px-3 py-2 text-sm text-white mt-1">
            ...
            <div>
              ...
              <Input value={settings.vatRate} onChange={e => upd("vatRate", e.target.value)} type="number" className="bg-[#0a0a1a] border-[#2a2a3e] text-white mt-1" dir="ltr" />
            </div>
            <div>
