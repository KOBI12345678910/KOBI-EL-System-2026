          ...
          return (
                  <div className="flex items-center justify-center h-96">
                          <div className="text-center">
                                    ...
                                    <p className="text-gray-500 text-lg font-medium">Loading Platform...</p>
                          </div>
                  </div>
                );
    }
                ...
                <div className="mb-8 flex items-start justify-between flex-wrap gap-4">
                        <div>
                                  <div className="flex items-center gap-3 mb-2">
                                              ...
                                              <div>
                                                            <h1 className="text-3xl font-bold text-gray-900">Global Business Platform</h1>
                                                            <p className="text-gray-500 text-sm">3,000 Businesses &middot; 3 Billion End Users &middot; 195 Countries</p>
                                              </div>
                                  </div>
                        ...
                        <Card className="border-0 shadow-lg">
                            ...
                            <div key={mod.id} className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl hover:bg-blue-50 transition-colors cursor-pointer group">
                                              ...
                                              <div className="flex-1 min-w-0">
                                                                  ...
                                                                  <p className="text-xs text-gray-400 capitalize">{mod.category}</p>
                                              </div>
                              {mod.is_beta && (
                                                  <Badge className="text-xs bg-amber-100 text-amber-700 border-0 px-1">beta</Badge>
                                              )}
                            </div>
                          ))}
                                              </div>
                        ...
                        <Card className="border-0 shadow-lg">
                            ...
                            <div
                                              ...
                                              <div className="flex items-center gap-3">
                                                                  ...
                                                                  <div>
                                                                                        <p className="font-semibold text-gray-800">{plan.plan_name_en || plan.plan_code}</p>
                                              ...
                                              <div className="text-right">
                                                                  <p className="font-bold text-gray-900">${plan.price_monthly}/mo</p>
                                                                  <p className="text-xs text-emerald-600">${plan.price_yearly}/yr</p>
                                              </div>
                            </div>
                          ))}
                                              </div>
            ...
            {/* Organizations */}
                <Card className="border-0 shadow-lg">
                        ...
                        <div className="text-center py-16">
                                      ...
                                      <p className="text-xl font-semibold text-gray-500">Ready for 3,000 Businesses</p>
                          ...
                          {orgs.map((org) => (
                                          <div
                                                            ...
                                                            <div className="flex items-center gap-4">
                                                                                ...
                                                                                <div>
                                                                                                      <p className="font-semibold text-gray-800">{org.org_name}</p>
