...
export default function DataFlowAutomations() {
  ...
  const [history, setHistory] = useState<FlowResult[]>([]);
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            disabled={runningAll}
            className="px-5 py-2 rounded-lg text-sm font-bold bg-gradient-to-l from-blue-600 to-indigo-600 text-white hover:from-blue-700 hover:to-indigo-700 transition-all shadow-lg disabled:opacity-50 flex items-center gap-2"
          >
        ...
        {filteredFlows.map(flow => {
          ...
          return (
            <div key={flow.id} className="bg-card rounded-xl border border-border/50 p-4 hover:border-primary/30 transition-all group">
              ...
              <h3 className="font-bold text-sm text-white mb-1">{flow.name}</h3>
      ...
      {showHistory && (
        <div className="bg-card rounded-xl border border-border/50 p-4">
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-sm font-bold text-white flex items-center gap-2">📜 היסטוריית הרצות</h3>
              ...
              <tbody>
                {history.slice(0, 50).map((h, i) => (
                  <tr key={i} className="border-b border-border/20 hover:bg-muted/30">
                    ...
                    <td className="py-1.5 px-2 font-medium text-white">{h.flowName}</td>
                    ...
                    <td className="py-1.5 px-2 font-bold text-white">{h.recordsAffected}</td>
