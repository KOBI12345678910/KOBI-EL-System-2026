        ...
        {activeDetailTab === "tasks" && (
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              <button onClick={() => setShowTaskForm(!showTaskForm)} className="text-xs px-3 py-1.5 bg-blue-600 text-white rounded-lg">
        ...
        {activeDetailTab === "kpis" && (
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              <button onClick={() => setShowKpiForm(!showKpiForm)} className="text-xs px-3 py-1.5 bg-blue-600 text-white rounded-lg">
        ...
        {activeDetailTab === "deals" && (
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              <button onClick={() => setShowDealForm(!showDealForm)} className="text-xs px-3 py-1.5 bg-blue-600 text-white rounded-lg">
        ...
        {activeDetailTab === "monthly" && (
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              <button onClick={() => setShowMonthForm(!showMonthForm)} className="text-xs px-3 py-1.5 bg-blue-600 text-white rounded-lg">
      ...
      <div className="bg-card border rounded-xl shadow-xl w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto" dir="rtl" onClick={e => e.stopPropagation()}>
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4">
          ...
          <div className="flex items-center justify-end gap-2 pt-2 border-t">
            ...
            <button type="submit" disabled={saving || !form.fullName?.trim()} className="px-6 py-2 text-sm bg-blue-600 hover:bg-blue-700 text-white rounded-lg disabled:opacity-50 font-medium">
