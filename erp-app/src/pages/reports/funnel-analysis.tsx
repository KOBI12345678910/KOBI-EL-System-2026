...
import {
  Filter, ChevronLeft, Users, Target, FileText,
    ...
    <div className="space-y-4 sm:space-y-6" dir="rtl">
      ...
      <div>
        <h1 className="text-lg sm:text-2xl font-bold text-white flex items-center gap-2">
          <Filter className="w-6 h-6 text-purple-400" /> יחסי המרה ומשפך מכירות
        </h1>
        ...
        <Card className="bg-slate-900/50 border-slate-700/50 mb-6">
          <CardHeader>
            <CardTitle className="text-base flex items-center gap-2">
              <Filter className="w-4 h-4 text-purple-400" /> משפך מכירות (Sales Filter)
            </CardTitle>
          </CardHeader>
          <CardContent>
                  ...
                  <tbody>
                    {leadSourceBreakdown.map((ls: any, idx: number) => (
                      <tr key={idx} className="border-b border-slate-800/50">
                        <td className="p-3 text-white font-medium">{ls.source}</td>
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    {conversionByAgent.map((agent: any, idx: number) => (
                      <tr key={idx} className="border-b border-slate-800/50">
                        <td className="p-3 text-white font-medium">{agent.agent}</td>
