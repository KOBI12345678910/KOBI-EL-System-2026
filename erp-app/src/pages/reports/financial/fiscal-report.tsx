      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <Card className="bg-gradient-to-br from-green-500/10 to-green-600/5 border-green-500/20">
          <CardContent className="p-4">
            ...
            <p className="text-xl font-bold text-white">₪{fmt(totalIncome)}</p>
        ...
        <Card className="bg-gradient-to-br from-red-500/10 to-red-600/5 border-red-500/20">
          <CardContent className="p-4">
            ...
            <p className="text-xl font-bold text-white">₪{fmt(totalExpenses)}</p>
        ...
        <Card className={`bg-gradient-to-br ${grossProfit >= 0 ? "from-emerald-500/10 to-emerald-600/5 border-emerald-500/20" : "from-red-500/10 to-red-600/5 border-red-500/20"}`}>
          <CardContent className="p-4">
            ...
            <p className="text-xl font-bold text-white">₪{fmt(grossProfit)}</p>
                  ...
                  {monthly.length > 0 && (
                    <tfoot>
                      <tr className="border-t border-slate-700 font-bold">
                        <td className="p-3 text-white">סה"כ {fiscalYear}</td>
