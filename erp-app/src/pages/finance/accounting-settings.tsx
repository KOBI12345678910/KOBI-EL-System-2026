            ...
            <CardContent>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-lg sm:text-2xl font-bold text-white mt-1">{users.length}</p>
                </div>
            ...
            <CardContent>
              ...
              <div className="flex items-center justify-between mt-1 p-3 rounded-lg bg-slate-800/50 border border-slate-700">
                <div className="flex items-center gap-2">
                  <span className="text-white font-medium">{accountingFirm}</span>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between p-3 rounded-lg bg-slate-800/50">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm text-white font-medium">חיבור לרשות המסים</p>
              ...
              <div className="flex items-center justify-between p-3 rounded-lg bg-slate-800/50">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm text-white font-medium">סליקת אשראי בחשבון</p>
              ...
              <div className="flex items-center justify-between p-3 rounded-lg bg-slate-800/50">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm text-white font-medium">גבייה באמצעות מס"ב</p>
        ...
        <div className="space-y-4 sm:space-y-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              ...
              <Button className="bg-blue-600 hover:bg-blue-700 text-white" onClick={() => setAddUserDialogOpen(true)}>
                    ...
                    <tr key={user.id} className="border-b border-slate-800/50 hover:bg-slate-800/30">
                      ...
                      <td className="p-3">
                        <div className="flex items-center justify-center gap-1">
                          <button className="p-1.5 rounded hover:bg-slate-700 text-muted-foreground hover:text-white"><Edit2 className="w-4 h-4" /></button>
                          <button className="p-1.5 rounded hover:bg-slate-700 text-muted-foreground hover:text-white"><Eye className="w-4 h-4" /></button>
          ...
          <Card className="bg-slate-900/50 border-slate-700/50">
            ...
            <CardContent>
              ...
              <div className="flex items-center justify-between p-3 rounded-lg bg-slate-800/50 border border-slate-700">
                <div className="flex items-center gap-2">
                  <span className="text-white">{accountingFirm}</span>
                  <Info className="w-4 h-4 text-blue-400" />
                </div>
                <button className="text-muted-foreground hover:text-red-400"><Trash2 className="w-4 h-4" /></button>
              </div>
                ...
                <tbody>
                  {authorizedBusinesses.map((biz, i) => (
                    <tr key={i} className="border-b border-slate-800/50">
                      <td className="p-2 text-white">{biz.name}</td>
          ...
          <Card className="bg-slate-900/50 border-slate-700/50">
            ...
            <CardContent className="space-y-4 sm:space-y-6">
              <div className="p-4 rounded-lg bg-slate-800/50 border border-slate-700">
                ...
                <div className="flex items-center justify-between">
                  <div className="text-lg sm:text-2xl font-bold text-white">₪125 + מע"מ</div>
                  <Button variant="link" className="text-blue-400">הצגת פירוט חיוב מלא</Button>
                </div>
              </div>

              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-white">חשבוניות</h3>
                ...
                <div className="p-4 rounded-lg bg-slate-800/50 border border-slate-700">
                  ...
                  <div className="flex items-center justify-between mt-1">
                    <span className="text-white font-medium">חשבונית מס/קבלה / 279303 | 01/03/2026</span>
                ...
                <div className="p-4 rounded-lg bg-slate-800/50 border border-slate-700">
                  ...
                  <div className="flex items-center justify-between mt-1">
                    <span className="text-white font-medium">כרטיס אשראי 6156 עם תוקף 05/2031</span>
                    <div className="flex gap-2">
        ...
        <Card className="bg-slate-900/50 border-slate-700/50">
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between p-4 rounded-lg bg-slate-800/50 border border-slate-700">
              <div>
                <p className="text-white font-medium">שידור חשבוניות אוטומטי לרשות המסים</p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              {["PayPal", "Bit", "Apple Pay", "Google Pay", "סליקת אשראי", "מס\"ב"].map(mod => (
                <div key={mod} className="p-4 rounded-lg bg-slate-800/50 border border-slate-700 text-center">
                  <div className="text-white font-medium mb-2">{mod}</div>
      ...
      <Dialog open={addUserDialogOpen} onOpenChange={setAddUserDialogOpen}>
        <DialogContent className="bg-slate-900 border-slate-700 max-w-md" dir="rtl">
          ...
          <div className="space-y-4">
            ...
            <Button className="w-full bg-blue-600 hover:bg-blue-700 text-white" onClick={() => { setAddUserDialogOpen(false); toast({ title: "משתמש נוסף" }); }}>
      ...
      <Dialog open={addEmailDialogOpen} onOpenChange={setAddEmailDialogOpen}>
        <DialogContent className="bg-slate-900 border-slate-700 max-w-md" dir="rtl">
          ...
          <div className="space-y-4">
            ...
            <Button className="w-full bg-blue-600 hover:bg-blue-700 text-white" onClick={() => { setAddEmailDialogOpen(false); toast({ title: "מייל נוסף" }); }}>
      ...
      <Dialog open={addPhoneDialogOpen} onOpenChange={setAddPhoneDialogOpen}>
        <DialogContent className="bg-slate-900 border-slate-700 max-w-md" dir="rtl">
          ...
          <div className="space-y-4">
            ...
            <Button className="w-full bg-blue-600 hover:bg-blue-700 text-white" onClick={() => { setAddPhoneDialogOpen(false); toast({ title: "מספר נוסף" }); }}>
              <Plus className="w-4 h-4 ml-2" />הוסף
            </Button>
          </div>
        </DialogContent>
      ...
      <Dialog open={addBusinessDialogOpen} onOpenChange={setAddBusinessDialogOpen}>
        <DialogContent className="bg-slate-900 border-slate-700 max-w-md" dir="rtl">
          ...
          <div className="space-y-4">
            ...
            <Button className="w-full bg-blue-600 hover:bg-blue-700 text-white" onClick={() => { setAddBusinessDialogOpen(false); toast({ title: "עסק נוסף" }); }}>
