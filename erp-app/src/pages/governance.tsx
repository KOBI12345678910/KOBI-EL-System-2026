  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-xl sm:text-3xl font-bold text-white">ממשל נתונים</h1>
                  ...
                  {scopeRules.map(rule => {
                    ...
                    return (
                      <tr key={rule.id} className="border-b border-border/20 hover:bg-muted/5">
                        ...
                        <td className="px-4 py-3">
                          <button
                            onClick={async () => { if (globalConfirm("למחוק כלל זה?")) deleteScopeRuleMutation.mutate(rule.id); }}
