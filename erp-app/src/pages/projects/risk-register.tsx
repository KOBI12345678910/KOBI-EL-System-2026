            ...
            {[5, 4, 3, 2, 1].map(prob => (
              <tr key={prob}>
                ...
                {[1, 2, 3, 4, 5].map(impact => {
                  ...
                  return (
                    <td key={impact} className={`p-1 border border-gray-700/30 text-center transition-colors ${getCellColor(prob, impact)}`}>
                      <div className="min-h-[40px] flex items-center justify-center">
                        {cellRisks.length > 0 ? (
                          <div className="flex flex-wrap gap-1 justify-center p-1">
                            {cellRisks.map((r: any, i: number) => (
                              <div key={i} className="w-5 h-5 rounded-full bg-white/20 flex items-center justify-center text-xs text-white font-bold"
  ...
  return (
    <div className="p-6 space-y-6" dir="rtl">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-gray-100">רישום סיכונים</h1>
      ...
      {showForm && (
        <div className="rounded-xl border border-gray-700/50 bg-gray-800/30 p-6 space-y-4">
          <h2 className="text-lg font-semibold text-white">הוספת סיכון חדש</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="md:col-span-2 lg:col-span-3">
              ...
              <textarea className="w-full rounded-lg border border-gray-600 bg-gray-700/50 px-3 py-2 text-gray-200 h-20"
          ...
          <div className="flex justify-end gap-2 pt-2">
            <button onClick={() => { setShowForm(false); setForm({}); }}
              className="px-4 py-2 rounded-lg bg-gray-700 hover:bg-gray-600 text-gray-300 text-sm">ביטול</button>
              ...
              {loading ? (
                ...
                return (
                  <tr key={item.id || idx} className="hover:bg-gray-800/30 transition-colors">
                    ...
                    <td className="px-4 py-3 text-center font-bold text-gray-200">{item.risk_score}</td>
