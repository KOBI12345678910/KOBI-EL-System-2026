  ...
  return (
    ...
    >
      <motion.div
        ...
        className="w-full max-w-lg bg-[#0d1117] border border-gray-800 rounded-2xl overflow-hidden"
        dir="rtl"
      >
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-800 bg-purple-600/5">
          <h3 className="font-bold text-white">{model ? "עריכת מודל" : "הוספת מודל חדש"}</h3>
          <button onClick={onClose} className="p-2 text-muted-foreground hover:text-white rounded-lg">
            <X className="w-4 h-4" />
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <select
                ...
                className="w-full bg-[#1a1d23] border border-gray-700 rounded-xl px-3 py-2.5 text-sm text-white focus:outline-none focus:border-purple-500"
              >
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-[#1a1d23] border border-gray-700 rounded-xl px-3 py-2.5 text-sm text-white placeholder-gray-600 focus:outline-none focus:border-purple-500"
              required
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              dir="ltr"
              className="w-full bg-[#1a1d23] border border-gray-700 rounded-xl px-3 py-2.5 text-sm text-white placeholder-gray-600 focus:outline-none focus:border-purple-500 text-left"
              required
            />
          </div>
          ...
          <div className="grid grid-cols-3 gap-3">
            <div>
              ...
              <input
                ...
                dir="ltr"
                className="w-full bg-[#1a1d23] border border-gray-700 rounded-xl px-3 py-2.5 text-sm text-white focus:outline-none focus:border-purple-500 text-left"
              />
            </div>
            <div>
          ...
          <div className="flex justify-end gap-3 pt-4 border-t border-gray-800">
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2 text-sm text-muted-foreground hover:text-white rounded-xl transition-colors"
            >
              ביטול
            </button>
            <button
              type="submit"
              disabled={saving}
              className="px-4 py-2 text-sm bg-purple-600 text-white rounded-xl hover:bg-purple-700 disabled:opacity-50 transition-colors"
            >
              {saving ? "שומר..." : "שמור"}
            </button>
          </div>
    ...
    <div className="min-h-screen bg-[#080a0f] text-white" dir="rtl">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-6 py-6 space-y-6">
        ...
        <div className="flex items-start justify-between">
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <h1 className="text-2xl font-black text-white tracking-tight">מודלי AI</h1>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-xl bg-purple-600 text-white hover:bg-purple-700 transition-colors text-sm"
            >
          ...
          {[
            ...
            return (
              <motion.div
                ...
                className="bg-[#0d1117] border border-gray-800 rounded-2xl p-4"
              >
          ...
          <div className="flex items-center gap-3 flex-wrap">
            <div className="relative">
              ...
              <input
                ...
                className="bg-[#0d1117] border border-gray-800 rounded-xl pr-9 pl-4 py-2 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-purple-500/50 w-64"
              />
            </div>
            ...
            <div className="flex gap-1.5 flex-wrap">
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-colors ${
                  !selectedProvider ? "bg-purple-600/20 text-purple-400 border border-purple-500/40" : "bg-[#0d1117] text-muted-foreground border border-gray-800 hover:border-gray-600"
                }`}
              >
                הכל
              </button>
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-colors ${
                      selectedProvider === p.id
                        ...
                        : "bg-[#0d1117] text-muted-foreground border border-gray-800 hover:border-gray-600"
                    }`}
                  >
                    {p.name}
                  </button>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      <h3 className="font-bold text-white text-sm">{provider?.name || `Provider ${providerId}`}</h3>
                    ...
                    {providerModels.map(model => {
                      ...
                      return (
                        <motion.div
                          key={model.id}
                          whileHover={{ y: -2 }}
                          className={`bg-[#0d1117] border ${colors.border} rounded-2xl overflow-hidden group cursor-pointer`}
                          ...
                          <div className="px-4 py-3">
                            ...
                            <div className="grid grid-cols-2 gap-2 text-xs">
                              <div className="flex items-center gap-1.5 text-muted-foreground">
                                ...
                                <span>טוקנים: <span className="text-white font-mono">{formatTokenCount(model.maxTokens)}</span></span>
                              </div>
                              <div className="flex items-center gap-1.5 text-muted-foreground">
                                <Sparkles className="w-3 h-3" />
                                <span>סוג: <span className="text-white">{model.modelType}</span></span>
                              </div>
                            </div>
          ...
          <div className="bg-[#0d1117] border border-gray-800 rounded-2xl overflow-hidden">
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-gray-800 text-muted-foreground text-xs">
                ...
                <tbody>
                  {filteredModels.map(model => {
                    ...
                    return (
                      <tr key={model.id} className="border-b border-gray-800/50 hover:bg-card/[0.02] transition-colors">
                        ...
                        <td className="px-4 py-3 text-xs text-white font-mono">{formatTokenCount(model.maxTokens)}</td>
        ...
        {!modelsLoading && filteredModels.length === 0 && (
          <div className="text-center py-20 bg-[#0d1117] border border-gray-800 rounded-2xl">
            <Brain className="w-12 h-12 text-muted-foreground mx-auto mb-4" />
            <h3 className="text-white font-bold mb-2">לא נמצאו מודלים</h3>
            ...
            {[
              ...
              return (
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-2.5 rounded-xl bg-[#1a1d23] border border-gray-800 hover:border-gray-600 transition-colors text-sm text-gray-300 hover:text-white"
                >
