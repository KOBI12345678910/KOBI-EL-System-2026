                  ...
                  {dayList.map((d, i) => {
                    ...
                    return (
                      <div
                        ...
                        className={`border-r text-center py-1 text-xs font-medium flex-shrink-0 ${isToday ? "bg-blue-600 text-white" : isWeekend ? "bg-muted/50 text-muted-foreground" : "text-muted-foreground"}`}
                      >
                        {d.getDate()}
                ...
                return (
                  <div key={rowIdx} className="flex border-b hover:bg-muted/30" style={{ height: ROW_H }}>
                    ...
                    <div className="relative flex-1" style={{ height: ROW_H }}>
                      {visible && (
                        <div
                          className={`absolute top-1/2 -translate-y-1/2 h-6 rounded-md flex items-center px-2 text-white text-xs font-medium shadow-sm ${task.color}`}
