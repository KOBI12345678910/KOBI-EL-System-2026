  ...
  return (
    <div className="p-6 space-y-6" dir="rtl">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="bg-blue-600 text-white rounded-xl p-4 flex flex-col gap-2 shadow-sm">
      ...
      {overdueCritical.length > 0 && (
        <div className="bg-orange-50 border border-orange-200 rounded-xl p-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            {overdueCritical.slice(0, 6).map((a, i) => (
              <div key={i} className="bg-card border border-orange-200 rounded-lg p-3 shadow-sm">
                ...
                <div className="text-xs font-bold text-red-500">סטטוס: {a.status}</div>
              </div>
            ))}
          </div>
        </div>
                    ...
                    <tbody>
                      {purchaseOrders.map((r, i) => (
                        <tr key={i} className="border-t hover:bg-muted/30">
                          ...
                          <td className="p-3"><span className="bg-blue-100 text-blue-700 text-xs px-2 py-0.5 rounded-full">{r.status}</span></td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
            ...
            <div className="space-y-4 sm:space-y-6">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {[
                  ...
                  <div key={i} className="bg-card border rounded-xl p-4 shadow-sm text-center">
              ...
              <div>
                ...
                {teamMembers.length === 0 ? (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                    {teamMembers.slice(0, 12).map((m, i) => (
                      <div key={i} className="bg-card border rounded-xl p-4 shadow-sm flex items-center gap-3">
              ...
              <div>
                ...
                {customers.length === 0 ? (
                  ...
                  customers.slice(0, 10).map((c, i) => (
                    <div key={i} className="bg-card border rounded-xl p-4 shadow-sm flex flex-wrap items-center justify-between gap-3 mb-3">
