// Shared helpers for procurement v2 pages
import { useState } from "react";
import { useQuery } from "@tanstack/react-query";
import { authFetch } from "@/lib/utils";

export const API_BASE = "/api/procurement";
...
export function StatusBadge({ state }: { state?: string | null }) {
  ...
  const tone: Record<string, string> = {
    ...
    pending_approval: "bg-yellow-200 text-yellow-900",
    approved: "bg-green-200 text-green-900",
    active: "bg-green-200 text-green-900",
    submitted: "bg-blue-200 text-blue-900",
    sent: "bg-blue-200 text-blue-900",
    responded: "bg-indigo-200 text-indigo-900",
    awarded: "bg-emerald-200 text-emerald-900",
    matched: "bg-emerald-200 text-emerald-900",
    discrepancy: "bg-orange-200 text-orange-900",
    resolved: "bg-emerald-200 text-emerald-900",
    fully_received: "bg-emerald-200 text-emerald-900",
    partially_received: "bg-amber-200 text-amber-900",
  ...
  const cls = tone[state.toLowerCase()] ?? "bg-gray-100 text-gray-800";
