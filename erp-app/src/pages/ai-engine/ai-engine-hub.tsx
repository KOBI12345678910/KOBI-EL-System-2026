  ...
  return (
    <div className="space-y-8" dir="rtl">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-lg sm:text-2xl font-bold text-white">AI Engine Hub</h1>
      ...
      <div>
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-base font-semibold text-white">מודולי AI Engine</h2>
        </div>
            ...
            >
              <Link href={mod.href}>
                <div className={`bg-gradient-to-br ${mod.color} border ${mod.borderColor} rounded-2xl p-5 cursor-pointer hover:scale-[1.01] transition-transform group`}>
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-white/60">{mod.titleHe}</p>
                      </div>
                    </div>
                  ...
                  <p className="text-sm text-white/70 mb-4 leading-relaxed">{mod.description}</p>
      ...
      <div className="bg-card border border-border rounded-2xl p-5">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-base font-semibold text-white">פעילות AI — סיכום נוכחי</h2>
        </div>
        {loading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              ...
              <div key={i} className="text-center">
                <div className="text-lg sm:text-2xl font-bold text-white">{row.value}</div>
