  ...
  return (
    <div className="space-y-4 sm:space-y-6" dir="rtl">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold text-white">Call NLP Analysis</h1>
      ...
      <div className="bg-card border border-border rounded-xl overflow-hidden">
        <div className="flex items-center justify-between p-4 border-b border-border">
          <h3 className="font-semibold text-white text-sm">שיחות ואינטראקציות</h3>
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="font-medium text-white text-sm">{call.lead}</div>
                    ...
                    <div className="flex items-center gap-4">
                      {call.sentiment !== null && (
                        <div className="flex items-center gap-1.5">
                          ...
                          <span className="text-xs text-muted-foreground">סנטימנט: <span className="font-bold text-white">{call.sentiment}%</span></span>
                        </div>
                      )}
                      {call.buyIntent !== null && (
