...
const ICON_MAP: Record<string, React.ComponentType<{ className?: string }>> = {
  ...
  Receipt, Recycle, RotateCcw, Ruler, Scale, Scissors, Search, SearchCode, Send, Server, Settings, Share2,
  Shield, ShieldAlert, ShieldCheck, Ship, ShoppingCart, Smartphone, Sparkles, Star,
  Table2, Target, TestTube, TextCursorInput, ThumbsUp, Trash2, TrendingDown, TrendingUp, Truck,
...
const NAV_ITEMS: NavItem[] = [
    ...
    { href: "/ai-engine/knowledge-graph", label: "גרף ידע ארגוני", icon: Network, section: "מנוע בינה מלאכותית — AI", subSection: "מנוע ראשי" },
    { href: "/ai-engine/digital-twin", label: "תאום דיגיטלי", icon: Cpu, section: "מנוע בינה מלאכותית — AI", subSection: "מנוע ראשי" },
    { href: "/ai-engine/agent-orchestration", label: "תזמור סוכני AI", icon: Bot, section: "מנוע בינה מלאכותית — AI", subSection: "מנוע ראשי" },
    { href: "/ai-engine/predictive-analytics", label: "ניתוח חזוי (Predictive)", icon: TrendingUp, section: "מנוע בינה מלאכותית — AI", subSection: "AI מתקדם" },
    { href: "/ai-engine/optimization-lab", label: "מעבדת אופטימיזציה", icon: Zap, section: "מנוע בינה מלאכותית — AI", subSection: "AI מתקדם" },
    { href: "/ai-engine/document-intelligence", label: "אינטליגנציית מסמכים", icon: FileText, section: "מנוע בינה מלאכותית — AI", subSection: "AI מתקדם" },
    { href: "/ai-engine/process-mining", label: "כריית תהליכים", icon: Activity, section: "מנוע בינה מלאכותית — AI", subSection: "AI מתקדם" },
    { href: "/ai-engine/ai-agents", label: "צבא סוכני AI (12 סוכנים)", icon: Bot, section: "מנוע בינה מלאכותית — AI", subSection: "מנוע ראשי" },
    ...
    { href: "/executive/risk-management", label: "מרכז ניהול סיכונים", icon: Shield, section: "שולחן שליטה מנהלי", subSection: "סיכונים ובקרה" },
    { href: "/executive/daily-profit-monitor", label: "רווח יומי ובריאות החברה", icon: TrendingUp, section: "שולחן שליטה מנהלי", subSection: "דשבורדים" },
    { href: "/executive/fraud-detection", label: "זיהוי הונאות וחריגות", icon: ShieldAlert, section: "שולחן שליטה מנהלי", subSection: "סיכונים ובקרה" },
    ...
    { href: "/crm/customer-experience", label: "ניהול חוויית לקוח (CEM)", icon: Heart, section: "לקוחות ומכירות", subSection: "CRM ולקוחות" },
    { href: "/crm/agent-performance", label: "ניתוח ביצועי סוכנים", icon: Target, section: "לקוחות ומכירות", subSection: "CRM ולקוחות" },
    { href: "/crm/whatsapp-hub", label: "מרכז וואטסאפ + AI", icon: MessageCircle, section: "לקוחות ומכירות", subSection: "תקשורת" },
    { href: "/crm/call-analysis", label: "ניתוח הקלטות שיחה", icon: Phone, section: "לקוחות ומכירות", subSection: "תקשורת" },
    { href: "/crm/contract-intelligence", label: "אינטליגנציית חוזים", icon: Brain, section: "לקוחות ומכירות", subSection: "חוזים" },
    ...
    { href: "/finance", label: "דשבורד כספים", icon: DollarSign, section: "כספים" },
      ...
      { href: "/finance/revenue-recognition", label: "הכרה בהכנסות (ASC 606)", icon: TrendingUp, section: "כספים", subSection: "הנהלת חשבונות" },
      { href: "/finance/intercompany", label: "עסקאות בין-חברתיות", icon: Building2, section: "כספים", subSection: "הנהלת חשבונות" },
      { href: "/finance/three-way-match", label: "התאמה תלת-צדדית (3-Way Match)", icon: CheckSquare, section: "כספים", subSection: "זכאים" },
      { href: "/finance/project-cost-calculator", label: "מחשבון תמחור פרויקט", icon: Receipt, section: "כספים", subSection: "תמחור ועלויות" },
      { href: "/finance/ap-ar-control", label: "חייבים/זכאים (AR/AP)", icon: Scale, section: "כספים", subSection: "חייבים וזכאים" },
      { href: "/finance/financial-statements", label: "מאזן ודוחות כספיים", icon: FileBarChart, section: "כספים", subSection: "הנהלת חשבונות" },
      { href: "/finance/cashflow-management", label: "ניהול תזרים מזומנים", icon: TrendingUp, section: "כספים", subSection: "בנקים וקופה" },
      { href: "/finance/tax-management", label: "מס ומע\"מ (18%)", icon: Landmark, section: "כספים", subSection: "מיסים" },
    ...
    { href: "/procurement/vmi-consignment", label: "VMI ומלאי מועבר", icon: Package, section: "רכש ושרשרת אספקה" },
    ...
    { href: "/product-catalog", label: "קטלוג מוצרים", icon: Layers, section: "רכש ושרשרת אספקה" },
      ...
      { href: "/import/import-management", label: "ניהול יבוא מקיף", icon: Ship, section: "רכש ושרשרת אספקה", subSection: "ייבוא" },
    ...
    { href: "/inventory/remnant-management", label: "ניהול שאריות וחלקי חיתוך", icon: Recycle, section: "מלאי ולוגיסטיקה", subSection: "ניהול מלאי" },
    { href: "/inventory/raw-material-catalog", label: "קטלוג חומרי גלם (רמת הבורג)", icon: Layers, section: "מלאי ולוגיסטיקה", subSection: "ניהול מלאי" },
    ...
    // ── פיתוח מוצרים ──
    { href: "/production/engineering-change", label: "ניהול שינויים הנדסיים (ECR/ECO)", icon: FileText, section: "ייצור", subSection: "פיתוח מוצרים" },
    { href: "/production/cpq-configurator", label: "קונפיגורטור מוצרים (CPQ)", icon: Settings, section: "ייצור", subSection: "פיתוח מוצרים" },
    { href: "/production/cut-nesting", label: "אופטימיזציית חיתוך (Nesting)", icon: Scissors, section: "ייצור", subSection: "ניהול ייצור" },
    { href: "/production/dispatch-planning", label: "תכנון משלוחים ומשגור", icon: Truck, section: "ייצור", subSection: "לוגיסטיקה" },
    { href: "/production/supply-chain-traceability", label: "עקיבות שרשרת אספקה", icon: Link2, section: "ייצור", subSection: "לוגיסטיקה" },
    { href: "/production/iot-sensor-hub", label: "IoT — חיישנים ומכונות", icon: Cpu, section: "ייצור", subSection: "תחזוקה ונכסים" },
    { href: "/production/capacity-planning", label: "תכנון קיבולת ומשאבים", icon: BarChart3, section: "ייצור", subSection: "ניהול ייצור" },
    { href: "/production/supply-chain-workflow", label: "שרשרת אספקה — 18 שלבים", icon: Activity, section: "ייצור", subSection: "שרשרת אספקה" },
    { href: "/production/measurement-comparison", label: "השוואת מדידות (סוכן/מהנדס)", icon: Ruler, section: "ייצור", subSection: "שרשרת אספקה" },
    { href: "/production/bom-builder", label: "בונה עץ מוצר (BOM מתקדם)", icon: FolderTree, section: "ייצור", subSection: "BOM ועצי מוצר" },
    { href: "/production/scrap-tracker", label: "מעקב פסולת ופחת", icon: Trash2, section: "ייצור", subSection: "בקרת איכות" },
    { href: "/production/tool-equipment", label: "ניהול כלים, מכונות וציוד", icon: Wrench, section: "ייצור", subSection: "תחזוקה ונכסים" },
    { href: "/production/safety-incidents", label: "בטיחות ותקריות", icon: ShieldAlert, section: "ייצור", subSection: "בטיחות" },
    ...
    { href: "/projects/variation-orders", label: "הזמנות שינוי (Variation Orders)", icon: FileText, section: "ניהול פרויקטים" },
    ...
    { href: "/hr/performance-okr", label: "ביצועים ו-OKR", icon: Target, section: "משאבי אנוש" },
    { href: "/hr/employee-value-analysis", label: "ניתוח שווי עובד/קבלן", icon: DollarSign, section: "משאבי אנוש" },
    { href: "/hr/smart-payroll", label: "מחשבון שכר חכם", icon: Receipt, section: "משאבי אנוש" },
    { href: "/hr/recruitment", label: "גיוס עובדים", icon: UserPlus, section: "משאבי אנוש" },
    { href: "/hr/shift-scheduling", label: "משמרות ונוכחות", icon: Clock, section: "משאבי אנוש" },
    ...
    // ═══════════════ 12a. אסטרטגיה וחזון ═══════════════
      ...
      { href: "/strategy/competitor-intelligence", label: "מודיעין מתחרים ושוק", icon: Eye, section: "אסטרטגיה וחזון" },
    ...
    // ═══════════════ 12b. שיווק ═══════════════
      ...
      { href: "/marketing/social-marketing", label: "שיווק ברשתות חברתיות", icon: Share2, section: "שיווק" },
    ...
    // ═══════════════ 13. מסמכים וחוזים ═══════════════
      ...
      { href: "/documents/document-templates", label: "מנוע תבניות מסמכים", icon: FileText, section: "מסמכים וחוזים" },
    ...
    // ═══════════════ 13.5 דוחות ═══════════════
      ...
      { href: "/reports/metric-dictionary", label: "מילון KPI ומדדים", icon: BookOpen, section: "דוחות" },
      { href: "/reports/esg-sustainability", label: "ESG ובר-קיימא", icon: Lightbulb, section: "דוחות" },
    ...
    { href: "/reports/bi-dashboard", label: "BI Dashboard", icon: BarChart3, section: "דוחות" },
      ...
      { href: "/installations/installation-scheduler", label: "מתזמן התקנות חכם", icon: CalendarDays, section: "מתקנים והתקנות" },
    ...
    // ═══════════════ 15. הגדרות מערכת ═══════════════
      ...
      { href: "/settings/sla-management", label: "ניהול SLA", icon: Shield, section: "הגדרות מערכת", subSection: "הגדרות כלליות" },
      { href: "/settings/multi-site", label: "ניהול אתרים מרובים", icon: Building2, section: "הגדרות מערכת", subSection: "הגדרות כלליות" },
      { href: "/support/warranty-management", label: "ניהול אחריות", icon: ShieldCheck, section: "הגדרות מערכת", subSection: "שירות ותמיכה" },
      { href: "/settings/feature-flags", label: "דגלי פיצ'רים", icon: Flag, section: "הגדרות מערכת", subSection: "הגדרות מתקדמות" },
      { href: "/settings/import-staging", label: "אזור ייבוא נתונים", icon: Upload, section: "הגדרות מערכת", subSection: "הגדרות מתקדמות" },
      { href: "/settings/duplicate-resolution", label: "מרכז כפילויות", icon: Copy, section: "הגדרות מערכת", subSection: "הגדרות מתקדמות" },
      { href: "/settings/realtime-collaboration", label: "שיתוף פעולה בזמן אמת", icon: Users, section: "הגדרות מערכת", subSection: "הגדרות מתקדמות" },
      { href: "/settings/intelligent-notifications", label: "התראות חכמות", icon: Bell, section: "הגדרות מערכת", subSection: "הגדרות מתקדמות" },
      { href: "/settings/department-manager", label: "מבנה ארגוני ומחלקות", icon: Building2, section: "הגדרות מערכת", subSection: "ארגון" },
    ...
    // ── פורטלים ──
      ...
      { href: "/portal/customer-portal", label: "פורטל לקוחות (מתקדם)", icon: Users, section: "הגדרות מערכת", subSection: "פורטלים" },
      { href: "/portal/supplier-portal-new", label: "פורטל ספקים (מתקדם)", icon: Package, section: "הגדרות מערכת", subSection: "פורטלים" },
      { href: "/mobile/field-operations", label: "אפליקציית שטח (מתקינים/מודדים)", icon: Smartphone, section: "הגדרות מערכת", subSection: "פורטלים" },
