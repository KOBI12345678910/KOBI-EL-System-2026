            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-3 bg-card/5 rounded-lg">
                  ...
                  <button onClick={() => updateSetting("autoSuggest", !settings.autoSuggest)} className={`w-12 h-6 rounded-full transition ${settings.autoSuggest ? "bg-green-500" : "bg-muted"} relative`}>
                ...
                <div className="flex items-center justify-between p-3 bg-card/5 rounded-lg">
                  ...
                  <button onClick={() => updateSetting("notifyOnHighScore", !settings.notifyOnHighScore)} className={`w-12 h-6 rounded-full transition ${settings.notifyOnHighScore ? "bg-green-500" : "bg-muted"} relative`}>
