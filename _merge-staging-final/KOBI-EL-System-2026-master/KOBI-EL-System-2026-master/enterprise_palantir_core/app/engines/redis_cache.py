"""
Redis Cache Abstraction — drop-in swap for an in-memory dict when
REDIS_URL is not set.

Used as a hot layer in front of the state store: when a WebSocket
client subscribes to /ws/{tenant_id}, it gets the cached state rather
than hitting the database on every render.
"""
