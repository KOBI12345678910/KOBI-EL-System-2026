...
import {
  ...
  PieChart, Pie, Cell, Legend, FunnelChart, Filter, LabelList,
} from "recharts";
import {
                    ...
                    return (
                      <div key={step.name} className="space-y-1">
                        ...
                        <div className="w-full bg-muted rounded-full h-8 overflow-hidden">
                          <div
                            className="h-full rounded-full transition-all duration-700 flex items-center justify-center text-white text-xs font-bold"
