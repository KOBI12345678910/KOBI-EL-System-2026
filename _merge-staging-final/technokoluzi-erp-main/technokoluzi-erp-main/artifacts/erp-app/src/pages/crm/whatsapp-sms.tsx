              ...
              filtered.map(c => (
                <div key={c.id} onClick={() => setSelected(c)}
                  ...
                  <div className="relative">
                    ...
                    <div className={`absolute -bottom-0.5 -left-0.5 w-4 h-4 rounded-full flex items-center justify-center text-[9px] font-bold text-white ${c.channel === "whatsapp" ? "bg-green-500" : "bg-blue-500"}`}>
