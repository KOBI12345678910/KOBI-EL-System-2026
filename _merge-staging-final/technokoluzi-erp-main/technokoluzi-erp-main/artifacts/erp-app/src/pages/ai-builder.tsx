  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-xl sm:text-3xl font-bold text-white">בונה AI</h1>
              ...
              <Card key={config.id} className="flex flex-col hover:border-primary/30 transition-colors">
                <div className="p-5 flex items-start justify-between">
                  ...
                  <div className="flex gap-1">
                    <button onClick={() => openEdit(config)} className="p-2 text-muted-foreground hover:bg-card/10 hover:text-white rounded-lg transition-colors">
                      <Edit2 className="w-4 h-4" />
                    </button>
                    <button onClick={async () => {
                      if (globalConfirm("למחוק תצורה זו?")) deleteMutation.mutate(config.id);
                ...
                <div className="p-4 border-t border-border/30 flex justify-between items-center">
                  ...
                  <button onClick={() => setShowLogsForId(config.id)} className="flex items-center gap-1.5 text-sm text-muted-foreground hover:text-white transition-colors">
