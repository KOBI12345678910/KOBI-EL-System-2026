...
function ScoreBar({ value, max = 100, color = "bg-emerald-500" }: { value: number; max?: number; color?: string }) {
  ...
  return (
    <div className="w-full bg-[#12141a] rounded-full h-1.5">
  ...
  return (
    <div className="min-h-screen" dir="rtl">
      <div className="p-6 space-y-6 max-w-[1600px] mx-auto">
        ...
        <div className="bg-[#1a1d23] border border-gray-800 rounded-xl p-5 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pr-9 pl-4 py-2.5 bg-[#12141a] border border-gray-700 rounded-xl text-white placeholder-gray-500 focus:border-cyan-500 focus:outline-none text-sm"
                />
              </div>
              {searchMaterial && filteredMaterials.length > 0 && (
                <div className="absolute z-20 bg-[#1a1d23] border border-gray-700 rounded-xl shadow-xl max-h-48 overflow-y-auto mt-1 w-64">
                  {filteredMaterials.slice(0, 10).map(m => (
                    <button key={m.id} onClick={() => { setSelectedMaterialId(String(m.id)); setSearchMaterial(m.materialName); setSelectedGroup(""); }}
                      className="w-full px-4 py-2 text-right text-sm text-white hover:bg-[#2a2d33] border-b border-gray-800/50">
            ...
            <div className="space-y-2">
              ...
              <select
                ...
                className="w-full px-3 py-2.5 bg-[#12141a] border border-gray-700 rounded-xl text-white focus:border-cyan-500 focus:outline-none text-sm"
              >
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {[
              ...
              <button key={s.key} onClick={() => setSortBy(s.key as any)}
                className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-colors ${sortBy === s.key ? "bg-cyan-500/20 text-cyan-400 border border-cyan-500/30" : "bg-[#12141a] text-muted-foreground hover:text-white"}`}>
        ...
        {!selectedMaterialId && !selectedGroup ? (
          ...
          <div className="space-y-4">
            {comparisonData.map((row, rowIdx) => {
              ...
              return (
                <div key={rowIdx} className="bg-[#1a1d23] border border-gray-800 rounded-xl overflow-hidden">
                  <div
                    className="px-5 py-4 flex items-center justify-between cursor-pointer hover:bg-[#1e2128] transition-colors"
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h3 className="text-white font-semibold">{row.itemDescription}</h3>
                      ...
                      <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: "auto", opacity: 1 }} exit={{ height: 0, opacity: 0 }}
                        ...
                        <div className="p-5">
                                ...
                                {sortedEntries.map((entry, idx) => {
                                  ...
                                  return (
                                    <tr key={entry.quoteId}
                                      className={`border-b border-gray-800/50 transition-colors ${isBest ? "bg-emerald-500/5" : entry.isRecommended ? "bg-amber-500/5" : "hover:bg-[#1e2128]"}`}>
                                      ...
                                      <td className="px-3 py-3">
                                        <div>
                                          <p className="text-white font-medium text-sm">{supplier?.supplierName || `ספק ${entry.supplierId}`}</p>
                                      ...
                                      <td className="px-3 py-3">
                                        <div>
                                          <p className={`font-bold text-sm ${isBest ? "text-emerald-400" : "text-white"}`}>
                                      ...
                                      <td className="px-3 py-3">
                                        <div className="flex items-center gap-1.5">
                                          ...
                                          <span className={`text-sm ${entry.deliveryDays && entry.deliveryDays <= 7 ? "text-emerald-400" : entry.deliveryDays && entry.deliveryDays <= 14 ? "text-amber-400" : "text-white"}`}>
                                      ...
                                      <td className="px-3 py-3">
                                        <div className="space-y-1">
                                          <p className={`text-sm font-bold ${score >= 80 ? "text-emerald-400" : score >= 60 ? "text-amber-400" : "text-white"}`}>
                                            {score}/100
                                          </p>
                          ...
                          {sortedEntries.length > 0 && (
                            <div className="mt-5 p-4 bg-[#12141a] rounded-xl border border-gray-700">
                              ...
                              <div className="flex items-start gap-4 flex-wrap">
                                  ...
                                  {(() => {
                                    ...
                                    return (
                                      <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                          <p className="text-white font-medium">{supplier?.supplierName}</p>
                                ...
                                <div className="grid grid-cols-3 gap-3 flex-1 min-w-[300px]">
                                  <div className="text-center bg-[#1a1d23] rounded-xl p-3">
                                  ...
                                  <div className="text-center bg-[#1a1d23] rounded-xl p-3">
                                    <p className="text-white text-lg font-bold">{row.entries.length}</p>
