    ...
    <div className="space-y-4 sm:space-y-6" dir="rtl">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} dir="rtl">
        ...
        <TabsContent value="details" className="mt-4">
          <Card className="bg-slate-900/50 border-slate-700/50">
            <CardHeader><CardTitle className="text-white flex items-center gap-2"><FolderKanban className="w-5 h-5 text-violet-400" />פרטי ניתוח</CardTitle></CardHeader>
        ...
        <TabsContent value="materials" className="mt-4">
          <Card className="bg-slate-900/50 border-slate-700/50">
            <CardHeader>
              <div className="flex items-center justify-between">
                <CardTitle className="text-white flex items-center gap-2"><Package className="w-5 h-5 text-orange-400" />חומרי גלם ומוצרים</CardTitle>
                  ...
                  <table className="w-full text-sm">
                      ...
                      {materials.map((m) => {
                        ...
                        return (
                          <tr key={m.id} className="border-b border-slate-800 hover:bg-slate-800/50">
                            <td className="p-2 text-white">{m.materialName}</td>
                            ...
                            <td className="p-2">
                              <Button variant="ghost" size="sm" className="text-red-400 h-7 w-7 p-0" onClick={() => removeMaterialMutation.mutate(m.id)}>
                    ...
                    <tfoot>
                      <tr className="border-t border-slate-600">
                        <td colSpan={8} className="p-2 text-white font-medium text-left">סה"כ חומרים:</td>
        ...
        <TabsContent value="production" className="mt-4">
          <Card className="bg-slate-900/50 border-slate-700/50">
            <CardHeader><CardTitle className="text-white flex items-center gap-2"><Calculator className="w-5 h-5 text-cyan-400" />עלויות ייצור</CardTitle></CardHeader>
            <CardContent>
        ...
        <TabsContent value="credit" className="mt-4">
          <Card className="bg-slate-900/50 border-slate-700/50">
            <CardHeader><CardTitle className="text-white flex items-center gap-2"><DollarSign className="w-5 h-5 text-yellow-400" />הגדרות אשראי / תשלום</CardTitle></CardHeader>
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div>
        ...
        <TabsContent value="additions" className="mt-4 space-y-4">
          <Card className="bg-slate-900/50 border-slate-700/50">
            <CardHeader><CardTitle className="text-white flex items-center gap-2"><TrendingUp className="w-5 h-5 text-purple-400" />תוספות פיננסיות</CardTitle></CardHeader>
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                <div>
          ...
          <Card className="bg-slate-900/50 border-slate-700/50">
            <CardHeader>
              <div className="flex items-center justify-between">
                <CardTitle className="text-white flex items-center gap-2"><DollarSign className="w-5 h-5 text-green-400" />עלויות נוספות</CardTitle>
              ...
              {costs.length === 0 ? (
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-sm">
                    ...
                    <tbody>
                      {costs.map((c) => (
                        <tr key={c.id} className="border-b border-slate-800 hover:bg-slate-800/50">
                          <td className="p-2 text-white">{c.costType}</td>
                          ...
                          <td className="p-2">
                            <Button variant="ghost" size="sm" className="text-red-400 h-7 w-7 p-0" onClick={() => removeCostMutation.mutate(c.id)}>
                              <Trash2 className="w-3.5 h-3.5" />
                            </Button>
                          </td>
                        </tr>
                    ...
                    <tfoot>
                      <tr className="border-t border-slate-600">
                        <td colSpan={2} className="p-2 text-white font-medium text-left">סה"כ עלויות נוספות:</td>
        ...
        <TabsContent value="summary" className="mt-4">
          <Card className="bg-slate-900/50 border-slate-700/50">
            <CardHeader><CardTitle className="text-white flex items-center gap-2"><Calculator className="w-5 h-5 text-blue-400" />סיכום עלויות</CardTitle></CardHeader>
            <CardContent>
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center p-3 bg-slate-800 rounded-lg">
                  <span className="text-white font-bold">עלות כוללת לפני מע"מ</span>
                ...
                <div className="flex justify-between items-center p-3 bg-blue-500/10 rounded-lg border border-blue-500/30">
                  <span className="text-white font-bold">סכום כולל עם מע"מ</span>
        ...
        <TabsContent value="profitability" className="mt-4">
          <Card className="bg-slate-900/50 border-slate-700/50">
            <CardHeader><CardTitle className="text-white flex items-center gap-2"><TrendingUp className="w-5 h-5 text-green-400" />ניתוח רווחיות</CardTitle></CardHeader>
            <CardContent className="space-y-4">
        ...
        <TabsContent value="risk" className="mt-4">
          <Card className="bg-slate-900/50 border-slate-700/50">
            <CardHeader><CardTitle className="text-white flex items-center gap-2"><Shield className="w-5 h-5 text-amber-400" />מדדי סיכון</CardTitle></CardHeader>
            <CardContent className="space-y-4 sm:space-y-6">
              ...
              <div className="space-y-3">
                <h3 className="text-white font-medium">פירוט סיכונים</h3>
              ...
              <div>
                <h3 className="text-white font-medium mb-3">מטריצת סיכון</h3>
                <RiskMatrix />
              </div>
            </CardContent>
          </Card>
        ...
        <TabsContent value="simulation" className="mt-4 space-y-4">
          <Card className="bg-slate-900/50 border-slate-700/50">
            <CardHeader><CardTitle className="text-white flex items-center gap-2"><BarChart3 className="w-5 h-5 text-indigo-400" />סימולציות What-If</CardTitle></CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div>
                  ...
                  <div className="flex gap-2 mt-1">
                    {[-30, -20, -10, 0, 10, 20, 30].map(v => (
                      <button
                        ...
                        className={`px-2 py-1 rounded text-xs ${simMaterialChange === v ? "bg-indigo-600 text-white" : "bg-slate-800 text-muted-foreground hover:bg-slate-700"}`}
                      >
                        {v > 0 ? "+" : ""}{v}%
                      </button>
                    ))}
                  ...
                  <div className="flex gap-2 mt-1">
                    {[-20, -10, 0, 10, 20].map(v => (
                      <button
                        ...
                        className={`px-2 py-1 rounded text-xs ${simCurrencyChange === v ? "bg-indigo-600 text-white" : "bg-slate-800 text-muted-foreground hover:bg-slate-700"}`}
                      >
                        {v > 0 ? "+" : ""}{v}%
                      </button>
                    ))}
                  ...
                  return (
                    <div key={label} className={`p-4 rounded-lg border ${delta < 0 ? "bg-green-500/5 border-green-500/20" : delta === 0 ? "bg-blue-500/5 border-blue-500/20" : "bg-red-500/5 border-red-500/20"}`}>
                      ...
                      <div className="space-y-1 text-sm">
                        <div className="flex justify-between"><span className="text-muted-foreground">עלות:</span><span className="text-white">{fmt(adjTotal)}</span></div>
              ...
              <div>
                <h3 className="text-white font-medium mb-3">ניתוח רגישות</h3>
                <div className="overflow-x-auto">
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="border-b border-slate-700 text-muted-foreground">
                      ...
                      {[-30, -20, -10, 0, 10, 20, 30].map(pctChange => {
                        ...
                        return (
                          <tr key={pctChange} className={`border-b border-slate-800 ${pctChange === 0 ? "bg-slate-800/50" : ""}`}>
                            <td className="p-2 text-white">{pctChange > 0 ? "+" : ""}{pctChange}%</td>
          ...
          <Card className="bg-slate-900/50 border-slate-700/50">
            <CardHeader><CardTitle className="text-white flex items-center gap-2"><TrendingUp className="w-5 h-5 text-emerald-400" />NPV / IRR</CardTitle></CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="p-4 bg-slate-800 rounded-lg text-center">
              ...
              {serverCalc?.npvYears && (
                <div>
                  <h3 className="text-white font-medium mb-3">תזרים מזומנים מהוון (5 שנים)</h3>
              ...
              {serverCalc?.sensitivity && (
                <div>
                  <h3 className="text-white font-medium mb-3">ניתוח רגישות — מרג'ין לפי שינוי חומרים</h3>
          ...
          {simulations.length > 0 && (
            <Card className="bg-slate-900/50 border-slate-700/50">
              <CardHeader><CardTitle className="text-white text-sm">סימולציות שנשמרו ({simulations.length})</CardTitle></CardHeader>
              <CardContent>
                <div className="space-y-2">
                  {simulations.map((sim) => (
                    <div key={sim.id} className="p-3 bg-slate-800 rounded-lg">
                      <div className="flex justify-between items-center">
                        <span className="text-white text-sm">{sim.scenarioName}</span>
        ...
        <TabsContent value="history" className="mt-4">
          <Card className="bg-slate-900/50 border-slate-700/50">
            <CardHeader><CardTitle className="text-white flex items-center gap-2"><History className="w-5 h-5 text-muted-foreground" />היסטוריית שינויים</CardTitle></CardHeader>
            <CardContent>
