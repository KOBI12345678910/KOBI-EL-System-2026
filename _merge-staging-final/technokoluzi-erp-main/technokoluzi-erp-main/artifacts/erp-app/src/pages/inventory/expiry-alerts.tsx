        ...
        <div className="flex bg-card border border-border/50 rounded-lg overflow-hidden">
          <button onClick={() => setTab("expiry")}
            ...
            {expiryData?.summary?.expiredCount > 0 && (
              <span className="bg-red-500 text-white text-xs rounded-full px-1.5 py-0.5 min-w-[18px] text-center">{expiryData.summary.expiredCount}</span>
            )}
          </button>
          <button onClick={() => setTab("low-stock")}
            ...
            {stockData?.summary?.totalAlerts > 0 && (
              <span className="bg-amber-500 text-white text-xs rounded-full px-1.5 py-0.5 min-w-[18px] text-center">{stockData.summary.totalAlerts}</span>
            )}
          </button>
        </div>
