  ...
  return (
    <div className="space-y-6 p-4 md:p-6" dir="rtl">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-lg sm:text-2xl font-bold text-white flex items-center gap-3"><Users className="w-7 h-7 text-blue-400" /> משאבי אנוש — דשבורד</h1>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="border border-border/50 rounded-2xl p-4 bg-card">
            <h3 className="text-sm font-semibold text-white flex items-center gap-2 mb-3"><Calendar className="w-4 h-4 text-teal-400" /> חופשות</h3>
            <div className="space-y-2">
              <div className="flex justify-between text-sm"><span className="text-muted-foreground">{'סה"כ בקשות'}</span><span className="text-white font-medium">{fmt(leaves.total || 0)}</span></div>
          ...
          <div className="border border-border/50 rounded-2xl p-4 bg-card">
            <h3 className="text-sm font-semibold text-white flex items-center gap-2 mb-3"><Briefcase className="w-4 h-4 text-cyan-400" /> גיוס</h3>
            <div className="space-y-2">
              <div className="flex justify-between text-sm"><span className="text-muted-foreground">משרות פתוחות</span><span className="text-white font-medium">{fmt(recruitment.active || 0)}</span></div>
          ...
          <div className="border border-border/50 rounded-2xl p-4 bg-card">
            <h3 className="text-sm font-semibold text-white flex items-center gap-2 mb-3"><Award className="w-4 h-4 text-amber-400" /> הערכות</h3>
            <div className="space-y-2">
              <div className="flex justify-between text-sm"><span className="text-muted-foreground">{'סה"כ הערכות'}</span><span className="text-white font-medium">{fmt(reviews.total || 0)}</span></div>
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4" onClick={() => setViewDetail(null)}>
            <motion.div initial={{ scale: 0.95 }} animate={{ scale: 1 }} exit={{ scale: 0.95 }} className="bg-card border border-border rounded-2xl shadow-2xl w-full max-w-md max-h-[85vh] overflow-auto" onClick={e => e.stopPropagation()}>
              <div className="p-5 border-b border-border flex justify-between items-center">
                <h2 className="text-lg font-bold text-white flex items-center gap-2"><Users className="w-5 h-5 text-blue-400" />{viewDetail.title}</h2>
