          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <Card className="bg-slate-900/50 border-slate-700/50">
              <CardContent className="p-4 text-center">
                ...
                <p className="text-lg sm:text-2xl font-bold text-white">{stats.customers || 0}</p>
            ...
            <Card className="bg-slate-900/50 border-slate-700/50">
              <CardContent className="p-4 text-center">
                ...
                <p className="text-lg sm:text-2xl font-bold text-white">{stats.invoices || 0}</p>
            ...
            <Card className="bg-slate-900/50 border-slate-700/50">
              <CardContent className="p-4 text-center">
                ...
                <p className="text-lg sm:text-2xl font-bold text-white">₪{fmt(cashFlow.upcomingReceivables)}</p>
            ...
            <Card className="bg-slate-900/50 border-slate-700/50">
              <CardContent className="p-4 text-center">
                ...
                <p className="text-lg sm:text-2xl font-bold text-white">₪{fmt(totalExpenses)}</p>
                      ...
                      return (
                        <div key={i}>
                          <div className="flex justify-between text-sm mb-1">
                            ...
                            <span className="text-white">₪{fmt(c.value)} ({pct}%)</span>
                          </div>
