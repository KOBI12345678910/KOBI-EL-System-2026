...
export default function AICustomerServicePage() {
  ...
  return (
    <div className="p-6 space-y-6 max-w-5xl mx-auto" dir="rtl">
      ...
      <div className="grid md:grid-cols-2 gap-4">
        <div className="bg-card border border-border rounded-xl p-5 space-y-3">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-semibold text-white">בדיקת AI Support</h2>
          </div>
          ...
          <textarea
            ...
            className="w-full bg-background border border-border rounded-lg px-4 py-3 text-sm text-white placeholder-muted-foreground resize-none focus:outline-none focus:border-green-500 min-h-[90px]"
            disabled={loading}
          />
          <button
            onClick={handleSend}
            disabled={!question.trim() || loading}
            className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-green-600 hover:bg-green-500 disabled:bg-gray-700 disabled:cursor-not-allowed text-white rounded-lg text-sm font-medium transition-colors"
          >
            {loading ? (
              <>
        ...
        <div className="bg-card border border-border rounded-xl p-5 space-y-3 min-h-[220px]">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-semibold text-white">תגובת AI</h2>
          </div>
      ...
      <div>
        <h2 className="font-semibold text-white mb-3">יכולות AI Support</h2>
