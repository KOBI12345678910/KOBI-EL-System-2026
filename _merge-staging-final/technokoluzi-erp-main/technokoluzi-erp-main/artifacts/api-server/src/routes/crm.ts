...
import { computePaymentComparison, extractComparisonInputFromData, VAT_RATE } from "../lib/contractor-decision";
  ...
  try {
    ...
    const results = quotes.map((q: any) => {
      ...
      return {
        ...base,
        invoiceAmount,
        amountExVat: invoiceAmount > 0 ? Math.round((invoiceAmount / VAT_RATE) * 100) / 100 : 0,
