...
function calculatePayroll(emp: typeof entityRecordsTable.$inferSelect) {
  ...
  const taxRate = grossSalary > 25000 ? 0.35 : grossSalary > 15000 ? 0.25 : grossSalary > 8000 ? 0.15 : 0.10;
  const incomeTax = grossSalary * taxRate;
  const nationalInsurance = grossSalary * 0.0712;
  const healthInsurance = grossSalary * 0.031;
  ...
  const severanceContrib = grossSalary * 0.0833;
