...
const STATUSES = ["פעיל", "לא מוקצה", "פגום", "מבוטל"] as const;
const SC: Record<string, string> = { "פעיל": "bg-green-500/20 text-green-300", "לא מוקצה": "bg-blue-500/20 text-blue-300", "פגום": "bg-yellow-500/20 text-yellow-300", "מבוטל": "bg-purple-500/20 text-purple-300" };
const COLS = [
    { key: "code", label: "קוד" },
    { key: "type", label: "סוג" },
    { key: "item", label: "פריט" },
  ...
  return (
    <div className="p-6 space-y-6" dir="rtl">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-foreground">ניהול ברקודים / RFID</h1>
          <p className="text-sm text-muted-foreground mt-1">מעקב ברקודים ותגי RFID</p>
        </div>
