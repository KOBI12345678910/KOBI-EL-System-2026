...
const STATUSES = ["פנוי", "בטעינה", "בפריקה", "תפוס"] as const;
const SC: Record<string, string> = { "פנוי": "bg-green-500/20 text-green-300", "בטעינה": "bg-blue-500/20 text-blue-300", "בפריקה": "bg-yellow-500/20 text-yellow-300", "תפוס": "bg-purple-500/20 text-purple-300" };
const COLS = [
    { key: "dock", label: "רציף" },
  ...
  return (
    <div className="p-6 space-y-6" dir="rtl">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-foreground">ניהול רציף</h1>
          <p className="text-sm text-muted-foreground mt-1">תזמון וניהול רציפי טעינה/פריקה</p>
        </div>
