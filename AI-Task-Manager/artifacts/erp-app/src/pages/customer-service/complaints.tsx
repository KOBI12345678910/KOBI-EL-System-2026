...
const STATUSES = ["חדשה", "בטיפול", "ממתין ללקוח", "סגורה"] as const;
const SC: Record<string, string> = { "חדשה": "bg-green-500/20 text-green-300", "בטיפול": "bg-blue-500/20 text-blue-300", "ממתין ללקוח": "bg-yellow-500/20 text-yellow-300", "סגורה": "bg-purple-500/20 text-purple-300" };
const COLS = [
    { key: "id", label: "מזהה" },
  ...
  return (
    <div className="p-6 space-y-6" dir="rtl">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-foreground">תלונות לקוחות</h1>
          <p className="text-sm text-muted-foreground mt-1">ניהול ומעקב תלונות</p>
        </div>
