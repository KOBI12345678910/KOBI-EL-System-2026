...
const STATUSES = ["ממתין", "מאושר", "בטיפול", "סגור"] as const;
const SC: Record<string, string> = { "ממתין": "bg-green-500/20 text-green-300", "מאושר": "bg-blue-500/20 text-blue-300", "בטיפול": "bg-yellow-500/20 text-yellow-300", "סגור": "bg-purple-500/20 text-purple-300" };
const COLS = [
    { key: "rma", label: "RMA" },
  ...
  return (
    <div className="p-6 space-y-6" dir="rtl">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-foreground">החזרות — RMA</h1>
          <p className="text-sm text-muted-foreground mt-1">Return Material Authorization</p>
        </div>
