...
const STATUSES = ["שוטף", "30+", "60+", "90+"] as const;
const SC: Record<string, string> = { "שוטף": "bg-green-500/20 text-green-300", "30+": "bg-blue-500/20 text-blue-300", "60+": "bg-yellow-500/20 text-yellow-300", "90+": "bg-purple-500/20 text-purple-300" };
const COLS = [
...
export default function ReportCustomerAging() {
  ...
  return (
    <div className="p-6 space-y-6" dir="rtl">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-foreground">גיול לקוחות</h1>
