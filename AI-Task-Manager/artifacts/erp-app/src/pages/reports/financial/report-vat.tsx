...
const STATUSES = ["מוכן", "בעיבוד", "טיוטה", "ארכיון"] as const;
const SC: Record<string, string> = { "מוכן": "bg-green-500/20 text-green-300", "בעיבוד": "bg-blue-500/20 text-blue-300", "טיוטה": "bg-yellow-500/20 text-yellow-300", "ארכיון": "bg-purple-500/20 text-purple-300" };
const COLS = [
    { key: "period", label: "תקופה" },
    { key: "input", label: "תשומות" },
    { key: "output", label: "עסקאות" },
    { key: "net", label: "נטו" },
    { key: "status", label: "סטטוס" }
];

export default function ReportVat() {
