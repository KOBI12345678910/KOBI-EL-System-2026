...
const STATUSES = ["פעיל", "מופחת", "נמכר", "גרוטאה"] as const;
const SC: Record<string, string> = { "פעיל": "bg-green-500/20 text-green-300", "מופחת": "bg-blue-500/20 text-blue-300", "נמכר": "bg-yellow-500/20 text-yellow-300", "גרוטאה": "bg-purple-500/20 text-purple-300" };
const COLS = [
    { key: "asset", label: "נכס" },
    { key: "category", label: "קטגוריה" },
    { key: "cost", label: "עלות" },
    { key: "depreciation", label: "פחת" },
  ...
  return (
    <div className="p-6 space-y-6" dir="rtl">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-foreground">רכוש קבוע</h1>
