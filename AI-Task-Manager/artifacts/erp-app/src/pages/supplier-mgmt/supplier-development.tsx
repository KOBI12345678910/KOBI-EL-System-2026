...
const STATUSES = ["פעיל", "בתכנון", "הושלם", "מעוכב"] as const;
const SC: Record<string, string> = { "פעיל": "bg-green-500/20 text-green-300", "בתכנון": "bg-blue-500/20 text-blue-300", "הושלם": "bg-yellow-500/20 text-yellow-300", "מעוכב": "bg-purple-500/20 text-purple-300" };
const COLS = [
  ...
  return (
    <div className="p-6 space-y-6" dir="rtl">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-foreground">פיתוח ספקים</h1>
          <p className="text-sm text-muted-foreground mt-1">תוכניות שיפור ופיתוח ספקים</p>
        </div>
