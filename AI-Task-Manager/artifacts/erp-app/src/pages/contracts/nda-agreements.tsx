...
const STATUSES = ["חתום", "ממתין", "פג", "טיוטה"] as const;
const SC: Record<string, string> = { "חתום": "bg-green-500/20 text-green-300", "ממתין": "bg-blue-500/20 text-blue-300", "פג": "bg-yellow-500/20 text-yellow-300", "טיוטה": "bg-purple-500/20 text-purple-300" };
const COLS = [
    { key: "party", label: "צד" },
    { key: "scope", label: "היקף" },
    { key: "signed", label: "חתימה" },
  ...
  return (
    <div className="p-6 space-y-6" dir="rtl">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-foreground">הסכמי סודיות — NDA</h1>
          <p className="text-sm text-muted-foreground mt-1">Non-Disclosure Agreements</p>
        </div>
