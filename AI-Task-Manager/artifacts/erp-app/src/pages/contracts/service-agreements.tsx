...
const STATUSES = ["פעיל", "בחידוש", "פג", "מבוטל"] as const;
const SC: Record<string, string> = { "פעיל": "bg-green-500/20 text-green-300", "בחידוש": "bg-blue-500/20 text-blue-300", "פג": "bg-yellow-500/20 text-yellow-300", "מבוטל": "bg-purple-500/20 text-purple-300" };
const COLS = [
  ...
  return (
    <div className="p-6 space-y-6" dir="rtl">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-foreground">הסכמי שירות — SLA</h1>
          <p className="text-sm text-muted-foreground mt-1">חוזי שירות ותמיכה</p>
        </div>
