...
const STATUSES = ["פעיל", "לא פעיל", "מוגבל", "חדש"] as const;
const SC: Record<string, string> = { "פעיל": "bg-green-500/20 text-green-300", "לא פעיל": "bg-blue-500/20 text-blue-300", "מוגבל": "bg-yellow-500/20 text-yellow-300", "חדש": "bg-purple-500/20 text-purple-300" };
const COLS = [
    { key: "name", label: "שם" },
    { key: "code", label: "קוד" },
    { key: "type", label: "סוג" },
