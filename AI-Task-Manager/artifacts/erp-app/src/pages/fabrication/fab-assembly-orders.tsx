...
const STATUSES = ["חדשה", "בייצור", "מוכנה", "נשלחה"] as const;
const SC: Record<string, string> = { "חדשה": "bg-green-500/20 text-green-300", "בייצור": "bg-blue-500/20 text-blue-300", "מוכנה": "bg-yellow-500/20 text-yellow-300", "נשלחה": "bg-purple-500/20 text-purple-300" };
const COLS = [
