...
const STATUSES = ["חדשה", "בריתוך", "בדיקת איכות", "מוכנה"] as const;
const SC: Record<string, string> = { "חדשה": "bg-green-500/20 text-green-300", "בריתוך": "bg-blue-500/20 text-blue-300", "בדיקת איכות": "bg-yellow-500/20 text-yellow-300", "מוכנה": "bg-purple-500/20 text-purple-300" };
const COLS = [
    { key: "order", label: "הזמנה" },
    { key: "type", label: "סוג ריתוך" },
    { key: "material", label: "חומר" },
    { key: "welder", label: "רתך" },
  ...
  return (
    <div className="p-6 space-y-6" dir="rtl">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-foreground">הזמנות ריתוך</h1>
