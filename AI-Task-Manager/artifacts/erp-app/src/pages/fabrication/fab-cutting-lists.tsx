...
const STATUSES = ["טיוטה", "מאושרת", "בחיתוך", "הושלמה"] as const;
const SC: Record<string, string> = { "טיוטה": "bg-green-500/20 text-green-300", "מאושרת": "bg-blue-500/20 text-blue-300", "בחיתוך": "bg-yellow-500/20 text-yellow-300", "הושלמה": "bg-purple-500/20 text-purple-300" };
const COLS = [
    { key: "list", label: "רשימה" },
    { key: "profiles", label: "פרופילים" },
    { key: "pieces", label: "חלקים" },
    { key: "waste", label: "פחת" },
  ...
  return (
    <div className="p-6 space-y-6" dir="rtl">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-foreground">רשימות חיתוך</h1>
