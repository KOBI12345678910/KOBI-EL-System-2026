...
const STATUSES = ["חדשה", "בייצור", "מוכנה", "הותקנה"] as const;
const SC: Record<string, string> = { "חדשה": "bg-green-500/20 text-green-300", "בייצור": "bg-blue-500/20 text-blue-300", "מוכנה": "bg-yellow-500/20 text-yellow-300", "הותקנה": "bg-purple-500/20 text-purple-300" };
const COLS = [
    { key: "order", label: "הזמנה" },
    { key: "type", label: "סוג זכוכית" },
    { key: "sqm", label: "מ״ר" },
    { key: "due", label: "יעד" },
  ...
  return (
    <div className="p-6 space-y-6" dir="rtl">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-foreground">הזמנות זיגוג</h1>
