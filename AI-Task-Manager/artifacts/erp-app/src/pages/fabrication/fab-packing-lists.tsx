...
const STATUSES = ["טיוטה", "מוכנה", "נשלחה", "התקבלה"] as const;
const SC: Record<string, string> = { "טיוטה": "bg-green-500/20 text-green-300", "מוכנה": "bg-blue-500/20 text-blue-300", "נשלחה": "bg-yellow-500/20 text-yellow-300", "התקבלה": "bg-purple-500/20 text-purple-300" };
const COLS = [
  ...
  return (
    <div className="p-6 space-y-6" dir="rtl">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-foreground">רשימות אריזה</h1>
