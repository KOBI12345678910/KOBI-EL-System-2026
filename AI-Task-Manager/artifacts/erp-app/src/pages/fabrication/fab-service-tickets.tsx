...
const STATUSES = ["חדשה", "בטיפול", "ממתינה", "סגורה"] as const;
const SC: Record<string, string> = { "חדשה": "bg-green-500/20 text-green-300", "בטיפול": "bg-blue-500/20 text-blue-300", "ממתינה": "bg-yellow-500/20 text-yellow-300", "סגורה": "bg-purple-500/20 text-purple-300" };
const COLS = [
    { key: "ticket", label: "קריאה" },
    { key: "customer", label: "לקוח" },
    { key: "issue", label: "תקלה" },
