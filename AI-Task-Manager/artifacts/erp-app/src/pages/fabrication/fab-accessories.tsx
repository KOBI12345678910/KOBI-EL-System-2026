...
const STATUSES = ["במלאי", "חסר", "בהזמנה", "מבוטל"] as const;
const SC: Record<string, string> = { "במלאי": "bg-green-500/20 text-green-300", "חסר": "bg-blue-500/20 text-blue-300", "בהזמנה": "bg-yellow-500/20 text-yellow-300", "מבוטל": "bg-purple-500/20 text-purple-300" };
const COLS = [
    { key: "name", label: "שם" },
    { key: "sku", label: "מק״ט" },
    { key: "qty", label: "כמות" },
  ...
  return (
    <div className="p-6 space-y-6" dir="rtl">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-foreground">אביזרים</h1>
