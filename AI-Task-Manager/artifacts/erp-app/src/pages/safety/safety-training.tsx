...
const STATUSES = ["מתוכננת", "בביצוע", "הושלמה", "בוטלה"] as const;
const SC: Record<string, string> = { "מתוכננת": "bg-green-500/20 text-green-300", "בביצוע": "bg-blue-500/20 text-blue-300", "הושלמה": "bg-yellow-500/20 text-yellow-300", "בוטלה": "bg-purple-500/20 text-purple-300" };
const COLS = [
    { key: "training", label: "הדרכה" },
    { key: "trainer", label: "מדריך" },
  ...
  return (
    <div className="p-6 space-y-6" dir="rtl">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-foreground">הדרכות בטיחות</h1>
