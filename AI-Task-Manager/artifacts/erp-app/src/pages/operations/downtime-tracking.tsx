...
const STATUSES = ["פעיל", "מתוכנן", "לא מתוכנן", "נפתר"] as const;
const SC: Record<string, string> = { "פעיל": "bg-green-500/20 text-green-300", "מתוכנן": "bg-blue-500/20 text-blue-300", "לא מתוכנן": "bg-yellow-500/20 text-yellow-300", "נפתר": "bg-purple-500/20 text-purple-300" };
const COLS = [
  ...
  return (
    <div className="p-6 space-y-6" dir="rtl">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-foreground">מעקב השבתות</h1>
          <p className="text-sm text-muted-foreground mt-1">ניתוח זמני השבתה — OEE</p>
        </div>
