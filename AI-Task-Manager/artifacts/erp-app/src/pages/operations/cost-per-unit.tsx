...
const STATUSES = ["רגיל", "מעל תקן", "חסכוני", "לבדיקה"] as const;
const SC: Record<string, string> = { "רגיל": "bg-green-500/20 text-green-300", "מעל תקן": "bg-blue-500/20 text-blue-300", "חסכוני": "bg-yellow-500/20 text-yellow-300", "לבדיקה": "bg-purple-500/20 text-purple-300" };
const COLS = [
    { key: "product", label: "מוצר" },
    { key: "material", label: "חומר" },
    { key: "labor", label: "עבודה" },
    { key: "overhead", label: "תקורה" },
  ...
  return (
    <div className="p-6 space-y-6" dir="rtl">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-foreground">עלות ליחידה</h1>
          <p className="text-sm text-muted-foreground mt-1">ניתוח עלויות ייצור ליחידה</p>
        </div>
