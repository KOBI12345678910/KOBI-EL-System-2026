...
const STATUSES = ["פתוח", "נמסר", "מאושר", "ארכיון"] as const;
const SC: Record<string, string> = { "פתוח": "bg-green-500/20 text-green-300", "נמסר": "bg-blue-500/20 text-blue-300", "מאושר": "bg-yellow-500/20 text-yellow-300", "ארכיון": "bg-purple-500/20 text-purple-300" };
const COLS = [
  ...
  return (
    <div className="p-6 space-y-6" dir="rtl">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-foreground">מסירת משמרות</h1>
          <p className="text-sm text-muted-foreground mt-1">דוחות ומסירת משמרות</p>
        </div>
