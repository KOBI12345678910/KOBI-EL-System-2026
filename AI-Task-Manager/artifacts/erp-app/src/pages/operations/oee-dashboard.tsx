...
const STATUSES = ["מעולה", "טוב", "בינוני", "נמוך"] as const;
const SC: Record<string, string> = { "מעולה": "bg-green-500/20 text-green-300", "טוב": "bg-blue-500/20 text-blue-300", "בינוני": "bg-yellow-500/20 text-yellow-300", "נמוך": "bg-purple-500/20 text-purple-300" };
const COLS = [
    { key: "line", label: "קו" },
    { key: "availability", label: "זמינות" },
    { key: "performance", label: "ביצועים" },
    { key: "quality", label: "איכות" },
    { key: "status", label: "OEE" }
];
  ...
  return (
    <div className="p-6 space-y-6" dir="rtl">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-foreground">דשבורד OEE</h1>
