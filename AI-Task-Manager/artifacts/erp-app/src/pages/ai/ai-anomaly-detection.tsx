          ...
          {tab === "settings" && (
            <div className="bg-card/5 border border-white/10 rounded-xl p-6 space-y-6">
              ...
              <div className="flex items-center justify-between p-3 bg-card/5 rounded-lg">
                  ...
                  <button onClick={() => updateSetting("monitorFinancial", !settings.monitorFinancial)} className={`w-12 h-6 rounded-full transition ${settings.monitorFinancial ? "bg-green-500" : "bg-muted"} relative`}>
              ...
              <div className="flex items-center justify-between p-3 bg-card/5 rounded-lg">
                  ...
                  <button onClick={() => updateSetting("monitorOperational", !settings.monitorOperational)} className={`w-12 h-6 rounded-full transition ${settings.monitorOperational ? "bg-green-500" : "bg-muted"} relative`}>
              ...
              <div className="flex items-center justify-between p-3 bg-card/5 rounded-lg">
                  ...
                  <button onClick={() => updateSetting("monitorSecurity", !settings.monitorSecurity)} className={`w-12 h-6 rounded-full transition ${settings.monitorSecurity ? "bg-green-500" : "bg-muted"} relative`}>
              ...
              <div className="flex items-center justify-between p-3 bg-card/5 rounded-lg">
                  ...
                  <button onClick={() => updateSetting("realTimeAlerts", !settings.realTimeAlerts)} className={`w-12 h-6 rounded-full transition ${settings.realTimeAlerts ? "bg-green-500" : "bg-muted"} relative`}>
