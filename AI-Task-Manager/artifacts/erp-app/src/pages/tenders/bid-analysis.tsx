...
const STATUSES = ["בהערכה", "מוביל", "נדחה", "זכינו"] as const;
const SC: Record<string, string> = { "בהערכה": "bg-green-500/20 text-green-300", "מוביל": "bg-blue-500/20 text-blue-300", "נדחה": "bg-yellow-500/20 text-yellow-300", "זכינו": "bg-purple-500/20 text-purple-300" };
const COLS = [
    { key: "tender", label: "מכרז" },
    { key: "bidder", label: "מציע" },
  ...
  return (
    <div className="p-6 space-y-6" dir="rtl">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-foreground">ניתוח הצעות</h1>
          <p className="text-sm text-muted-foreground mt-1">השוואה וניתוח הצעות מכרז</p>
        </div>
