...
const STATUSES = ["פתוח", "בהכנה", "הוגש", "נסגר"] as const;
const SC: Record<string, string> = { "פתוח": "bg-green-500/20 text-green-300", "בהכנה": "bg-blue-500/20 text-blue-300", "הוגש": "bg-yellow-500/20 text-yellow-300", "נסגר": "bg-purple-500/20 text-purple-300" };
const COLS = [
    { key: "tender", label: "מכרז" },
    { key: "client", label: "מזמין" },
  ...
  return (
    <div className="p-6 space-y-6" dir="rtl">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-foreground">ניהול מכרזים</h1>
          <p className="text-sm text-muted-foreground mt-1">פרסום והשתתפות במכרזים</p>
        </div>
