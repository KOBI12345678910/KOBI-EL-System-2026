            ...
            {loading ? (
              Array.from({ length: 6 }).map((_, i) => (
                <tr key={i} className="border-b border-border/30 animate-pulse">
                  <td className="p-3"><div className="h-3 w-24 rounded bg-muted/20" /></td>
                  <td className="p-3"><div className="h-3 w-20 rounded bg-muted/20" /></td>
                  <td className="p-3"><div className="h-5 w-16 rounded-full bg-muted/15" /></td>
                  <td className="p-3"><div className="h-3 w-24 rounded bg-muted/20" /></td>
                  <td className="p-3"><div className="h-3 w-28 rounded bg-muted/20" /></td>
                  <td className="p-3"><div className="h-3 w-48 rounded bg-muted/15" /></td>
                  <td className="p-3"><div className="h-3 w-12 rounded bg-muted/10" /></td>
                </tr>
              ))
            ) : items.length === 0 ? (
              <tr>
                <td colSpan={7}>
                  <EmptyState
                    ...
                    description="לא נמצאו רשומות תואמות לסינון הנוכחי. נסה לשנות את הפילטרים או לרענן את הדף."
                    className="py-12"
                  />
                </td>
              </tr>
