...
const STATUSES = ["פעיל", "טיוטה", "פג תוקף", "ארכיון"] as const;
const SC: Record<string, string> = { "פעיל": "bg-green-500/20 text-green-300", "טיוטה": "bg-blue-500/20 text-blue-300", "פג תוקף": "bg-yellow-500/20 text-yellow-300", "ארכיון": "bg-purple-500/20 text-purple-300" };
const COLS = [
    { key: "list", label: "מחירון" },
    { key: "category", label: "קטגוריה" },
    { key: "items", label: "פריטים" },
    { key: "validUntil", label: "תוקף" },
  ...
  return (
    <div className="p-6 space-y-6" dir="rtl">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-foreground">מחירונים</h1>
