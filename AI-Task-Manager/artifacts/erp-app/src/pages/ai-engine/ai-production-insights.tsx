...
const STATUSES = ["חדש", "בניתוח", "מוכן", "יושם"] as const;
const SC: Record<string, string> = { "חדש": "bg-green-500/20 text-green-300", "בניתוח": "bg-blue-500/20 text-blue-300", "מוכן": "bg-yellow-500/20 text-yellow-300", "יושם": "bg-purple-500/20 text-purple-300" };
const COLS = [
    { key: "line", label: "קו" },
