...
const STATUSES = ["חם", "חמים", "קר", "לא רלוונטי"] as const;
const SC: Record<string, string> = { "חם": "bg-green-500/20 text-green-300", "חמים": "bg-blue-500/20 text-blue-300", "קר": "bg-yellow-500/20 text-yellow-300", "לא רלוונטי": "bg-purple-500/20 text-purple-300" };
const COLS = [
    { key: "lead", label: "ליד" },
  ...
  return (
    <div className="p-6 space-y-6" dir="rtl">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-foreground">דירוג לידים AI מתקדם</h1>
