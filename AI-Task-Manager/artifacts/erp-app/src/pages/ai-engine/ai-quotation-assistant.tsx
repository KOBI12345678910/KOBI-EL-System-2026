...
const STATUSES = ["טיוטה", "מוכן", "נשלח", "אושר"] as const;
const SC: Record<string, string> = { "טיוטה": "bg-green-500/20 text-green-300", "מוכן": "bg-blue-500/20 text-blue-300", "נשלח": "bg-yellow-500/20 text-yellow-300", "אושר": "bg-purple-500/20 text-purple-300" };
const COLS = [
  ...
  return (
    <div className="p-6 space-y-6" dir="rtl">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-foreground">עוזר הצעות מחיר AI</h1>
