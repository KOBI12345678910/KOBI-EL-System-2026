...
const STATUSES = ["חדש", "בטיפול", "הוצע", "סגור"] as const;
const SC: Record<string, string> = { "חדש": "bg-green-500/20 text-green-300", "בטיפול": "bg-blue-500/20 text-blue-300", "הוצע": "bg-yellow-500/20 text-yellow-300", "סגור": "bg-purple-500/20 text-purple-300" };
const COLS = [
  ...
  return (
    <div className="p-6 space-y-6" dir="rtl">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-foreground">עוזר מכירות AI</h1>
