...
const STATUSES = ["ממליץ", "מאושר", "בביצוע", "הושלם"] as const;
const SC: Record<string, string> = { "ממליץ": "bg-green-500/20 text-green-300", "מאושר": "bg-blue-500/20 text-blue-300", "בביצוע": "bg-yellow-500/20 text-yellow-300", "הושלם": "bg-purple-500/20 text-purple-300" };
const COLS = [
    { key: "item", label: "פריט" },
    { key: "supplier", label: "ספק" },
    { key: "saving", label: "חיסכון" },
  ...
  return (
    <div className="p-6 space-y-6" dir="rtl">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-foreground">אופטימיזציית רכש AI</h1>
