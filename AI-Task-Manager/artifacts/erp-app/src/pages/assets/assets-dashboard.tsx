...
const STATUSES = ["פעיל", "לא פעיל", "בתיקון", "למכירה"] as const;
const SC: Record<string, string> = { "פעיל": "bg-green-500/20 text-green-300", "לא פעיל": "bg-blue-500/20 text-blue-300", "בתיקון": "bg-yellow-500/20 text-yellow-300", "למכירה": "bg-purple-500/20 text-purple-300" };
const COLS = [
    { key: "asset", label: "נכס" },
  ...
  return (
    <div className="p-6 space-y-6" dir="rtl">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-foreground">דשבורד ניהול נכסים</h1>
          <p className="text-sm text-muted-foreground mt-1">מעקב רכוש קבוע ונכסי מפעל</p>
        </div>
