...
const STATUSES = ["מבוטח", "פג תוקף", "בחידוש", "ללא ביטוח"] as const;
const SC: Record<string, string> = { "מבוטח": "bg-green-500/20 text-green-300", "פג תוקף": "bg-blue-500/20 text-blue-300", "בחידוש": "bg-yellow-500/20 text-yellow-300", "ללא ביטוח": "bg-purple-500/20 text-purple-300" };
const COLS = [
    { key: "asset", label: "נכס" },
    { key: "insurer", label: "מבטח" },
  ...
  return (
    <div className="p-6 space-y-6" dir="rtl">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-foreground">ביטוחי ציוד</h1>
          <p className="text-sm text-muted-foreground mt-1">פוליסות ביטוח לציוד ונכסים</p>
        </div>
