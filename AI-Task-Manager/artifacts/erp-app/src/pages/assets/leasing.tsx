...
const STATUSES = ["פעיל", "מתחדש", "פג", "טיוטה"] as const;
const SC: Record<string, string> = { "פעיל": "bg-green-500/20 text-green-300", "מתחדש": "bg-blue-500/20 text-blue-300", "פג": "bg-yellow-500/20 text-yellow-300", "טיוטה": "bg-purple-500/20 text-purple-300" };
const COLS = [
    { key: "item", label: "פריט" },
    { key: "vendor", label: "ספק" },
    { key: "start", label: "תחילה" },
    { key: "end", label: "סיום" },
  ...
  return (
    <div className="p-6 space-y-6" dir="rtl">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-foreground">חוזי ליסינג</h1>
          <p className="text-sm text-muted-foreground mt-1">ניהול חוזי השכרה וליסינג</p>
        </div>
