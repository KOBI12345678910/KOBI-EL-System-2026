...
const STATUSES = ["חדש", "מיושם", "בדיון", "ארכיון"] as const;
const SC: Record<string, string> = { "חדש": "bg-green-500/20 text-green-300", "מיושם": "bg-blue-500/20 text-blue-300", "בדיון": "bg-yellow-500/20 text-yellow-300", "ארכיון": "bg-purple-500/20 text-purple-300" };
const COLS = [
  ...
  return (
    <div className="p-6 space-y-6" dir="rtl">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-foreground">לקחים נלמדים</h1>
          <p className="text-sm text-muted-foreground mt-1">תיעוד לקחים מפרויקטים ואירועים</p>
        </div>
