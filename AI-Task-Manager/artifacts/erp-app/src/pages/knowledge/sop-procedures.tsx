...
const STATUSES = ["פעיל", "בעדכון", "טיוטה", "מבוטל"] as const;
const SC: Record<string, string> = { "פעיל": "bg-green-500/20 text-green-300", "בעדכון": "bg-blue-500/20 text-blue-300", "טיוטה": "bg-yellow-500/20 text-yellow-300", "מבוטל": "bg-purple-500/20 text-purple-300" };
const COLS = [
    { key: "sop", label: "נוהל" },
    { key: "dept", label: "מחלקה" },
    { key: "version", label: "גרסה" },
    { key: "approved", label: "מאושר על ידי" },
  ...
  return (
    <div className="p-6 space-y-6" dir="rtl">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-foreground">נוהלי עבודה — SOP</h1>
